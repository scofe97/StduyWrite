...
| 10 | [`10_security/`](write/10_security/) | OAuth/JWT, OWASP, Spring Security |
| 11 | [`11_spring/`](write/11_spring/) | Spring Framework·Boot·Cloud (전 카테고리 집계는 하위 README) |
| 12 | [`12_AI/`](write/12_AI/) | 생성형 AI·에이전트 활용 |
| 13 | [`13_career/`](write/13_career/) | 커리어·성장 기록 |
...
- Spring 학습 진입점: [write/11_spring/README.md](write/11_spring/README.md)
