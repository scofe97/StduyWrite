...
sequenceDiagram
    ...
    Admin->>GitLab: POST /api/v4/users/{id}/block
    GitLab-->>Admin: User blocked

    Admin->>GitLab: POST /api/v4/users/{id}/unblock
    GitLab-->>Admin: User unblocked

    Admin->>GitLab: POST /api/v4/users/{id}/deactivate
    GitLab-->>Admin: User deactivated

    Admin->>GitLab: POST /api/v4/users/{id}/activate
    GitLab-->>Admin: User activated
```
...
| POST | `/api/v4/users/{id}/approve` | 사용자 승인 |
| POST | `/api/v4/users/{id}/reject` | 사용자 거부 |
| GET | `/api/v4/users/{userNo}/emails` | 사용자 이메일 조회 |
| POST | `/api/v4/users/{userNo}/emails` | 사용자 이메일 추가 |
| DELETE | `/api/v4/users/{userNo}/emails/{emailId}` | 사용자 이메일 삭제 |
...
| Method | Endpoint | 설명 |
|--------|----------|------|
| POST | `/gitlab/v3/select_user/tlId` | V3 사용자 페이지네이션 조회 |
