...
백엔드·Kubernetes 운영자는 [OS 로드맵](../roadmap/os-roadmap.md)의 1~4단계를 먼저 따릅니다. OOMKilled·CPU throttling·Pod 격리는 `kernel/`, DNS·Service·NAT 문제는 `networking/`, 성능 병목은 `book/systems-performance/`으로 확장합니다.
