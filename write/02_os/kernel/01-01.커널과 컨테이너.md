...
related:
  ...
  - ../../08_cloud/kubernetes/05-09.RBAC과 보안.md
  - ../../08_cloud/book/kubernetes-in-action/02-03.네임스페이스와 cgroup으로 보는 컨테이너 격리.md
updated: 2026-05-07
---
...
- 그래서 Pod의 `securityContext`나 `seccompProfile`로 시스템 콜 화이트리스트를 강제하는 것이 표준 패턴이다. 보안 정책 자체의 운영은 `10-02 RBAC과 보안` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-09.RBAC과 보안.md -->에서 다룬다.
...
- CPU throttling은 스케줄러 영역, OOMKilled는 메모리 관리 영역, "Pod가 안 뜬다"가 ImagePullBackOff면 VFS·블록 레이어, "Pod끼리는 되는데                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 Service가 안 된다"는 네트워크 스택. CPU·메모리 운영 디테일은 `10-03 자원 관리` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-10.자원 관리.md -->와 짝을 이뤄 보면 좋다.
...
K8s 네트워킹 측면의 디버깅 시퀀스는 [N&K 02-04 Linux 네트워크 진단 도구](../../08_cloud/book/networking-and-kubernetes/02-04.Linux%20%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%81%AC%20%EC%A7%84%EB%8B%A8%20%EB%8F%84%EA%B5%AC%20%E2%80%94%20%EA%B3%84%EC%B8%B5%20%EC%88%9C%EC%84%9C%EB%8C%80%EB%A1%9C%20%EC%88%98%EC%82%AC%ED%95%98%EA%B8%B0.md) §6 에서 이어진다.
...
K8s 측면의 패킷 흐름은 [Pod 네트워크와 Linux 기반](../../08_cloud/kubernetes/04_networking/04-02.Pod%20%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%81%AC%EC%99%80%20Linux%20%EA%B8%B0%EB%B0%98.md)에서 본 문서의 namespace·VFS·시스템 콜이 실제로 어떻게 결합되는지 보여 준다. netfilter 훅과 conntrack 을 커널 쪽에서 깊게 보려면 [N&K 02-02](../../08_cloud/book/networking-and-kubernetes/02-02.%EC%BB%A4%EB%84%90%EC%9D%B4%20%ED%8C%A8%ED%82%B7%EC%9D%84%20%ED%8C%90%EC%A0%95%ED%95%98%EB%8A%94%20%EC%B8%B5%20%E2%80%94%20Netfilter%C2%B7Conntrack%C2%B7%EB%9D%BC%EC%9A%B0%ED%8C%85.md)로 넘어간다. 본 문서 7절의 `bridge-nf-call-iptables` 는 이 문서가 정본이다.
...
- [N&K 02-01 커널이 패킷을 주고받는 자리](../../08_cloud/book/networking-and-kubernetes/02-01.%EC%BB%A4%EB%84%90%EC%9D%B4%20%ED%8C%A8%ED%82%B7%EC%9D%84%20%EC%A3%BC%EA%B3%A0%EB%B0%9B%EB%8A%94%20%EC%9E%90%EB%A6%AC%20%E2%80%94%20%EC%86%8C%EC%BC%93%C2%B7%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4%C2%B7veth%C2%B7%EB%B8%8C%EB%A6%AC%EC%A7%80.md) — 네트워크 namespace·veth
- [N&K 02-02 커널이 패킷을 판정하는 층](../../08_cloud/book/networking-and-kubernetes/02-02.%EC%BB%A4%EB%84%90%EC%9D%B4%20%ED%8C%A8%ED%82%B7%EC%9D%84%20%ED%8C%90%EC%A0%95%ED%95%98%EB%8A%94%20%EC%B8%B5%20%E2%80%94%20Netfilter%C2%B7Conntrack%C2%B7%EB%9D%BC%EC%9A%B0%ED%8C%85.md) — netfilter·conntrack·라우팅
- `Pod 네트워크와 Linux 기반` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/02-02.Pod 네트워크와 Linux 기반.md --> — K8s 측에서 본 같은 메커니즘
- `자원 관리` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-10.자원 관리.md --> — Requests/Limits, QoS, allocatable 계산
- `RBAC과 보안` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-09.RBAC과 보안.md --> — Pod Security Standards, seccomp, capabilities 운영
- [Kubernetes in Action 02-03. 네임스페이스와 cgroup으로 보는 컨테이너 격리](../../08_cloud/book/kubernetes-in-action/02-03.%EB%84%A4%EC%9E%84%EC%8A%A4%ED%8E%98%EC%9D%B4%EC%8A%A4%EC%99%80%20cgroup%EC%9C%BC%EB%A1%9C%20%EB%B3%B4%EB%8A%94%20%EC%BB%A8%ED%85%8C%EC%9D%B4%EB%84%88%20%EA%B2%A9%EB%A6%AC.md) — 이 편의 8종 네임스페이스·cgroup 설명을 책의 예시(네트워크·UTS)로 도입하는 편
