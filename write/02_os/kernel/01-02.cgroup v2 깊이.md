...
K8s 자원 정책 자체는 `10-03 자원 관리` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-10.자원 관리.md -->에서 설계 측면을 다룬다.
...
- K8s 측면 운영: `자원 관리` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-10.자원 관리.md -->
...
- `자원 관리` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-10.자원 관리.md --> — Requests/Limits, QoS, allocatable 운영
- `모니터링과 트러블슈팅` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-08.모니터링과 트러블슈팅.md --> — 노드 단위 진단
