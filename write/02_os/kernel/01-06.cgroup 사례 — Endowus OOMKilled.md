...
- `../../08_cloud/kubernetes/05-10.자원 관리.md` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-10.자원 관리.md --> — Pod requests/limits 결정 패턴
- `../../08_cloud/kubernetes/05-12.OOMKilled 사례 분석.md` <!-- 링크 끊김(2026-08): ../../08_cloud/kubernetes/05-12.OOMKilled 사례 분석.md --> — 같은 Endowus 사례를 K8s 운영자 관점(requests/limits 매핑·QoS·대시보드 운영)에서 풀이. 본 문서가 커널 메커니즘(RSS 합산·페이지 단위 reclaim·exit 137) 중심이라면 그쪽은 처방·일반화 운영 원칙 중심
