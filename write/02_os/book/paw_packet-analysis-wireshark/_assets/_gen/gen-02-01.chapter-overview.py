...
Y0 = 112
cards = [
    ("§1", "시작 화면의 네 갈래",        "어느 입구든 같은 캡처"),
    ("§2", "인터페이스 이름이 알려주는 것", "eth0 · lo0 · en0 · wlan0 가 뜻하는 것"),
    ("§3", "무엇을 얼마나 담을지",        "promiscuous · snaplen · 이름 해석"),
    ("§4", "디스크 앞에 서는 캡처 필터", "BPF 문법 · 버린 것은 복구 불가"),
    ("§5", "오래 잡을 때의 파일 분할",  "개수 · 크기 · 시간 · 벽시계 기준"),
    ("§6", "Wireshark 가 없는 서버에서",   "tcpdump · snoop 로 떠서 가져오기"),
    ("§7", "패킷이 안 보일 때",           "인터페이스 문제와 권한 문제 가르기"),
]
