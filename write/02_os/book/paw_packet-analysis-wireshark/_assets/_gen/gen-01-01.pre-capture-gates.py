...
step(CX, Y_S2, 280, 60, "인터페이스 선택 + promiscuous", "자기 앞 주소가 아닌 프레임까지 수신")
...
oval(648, Y_D1, 184, 40, "캡처하지 않음", BAD)
step(680, Y_D2 + 8, 240, 60, "monitor 모드로 전환", "WLAN 캡처에 필요")

d.t(CX + 14, Y_D1 + 96, "예", 11, MUTED, KR, "start", 600)
d.t(483, Y_D1 + 26, "아니오", 11, BAD, KR, "middle", 600)
d.t(CX - 12, Y_D2 + 92, "아니오", 11, MUTED, KR, "end", 600)
d.t(CX + 200, Y_D2 + 26, "예", 11, MUTED, KR, "middle", 600)
