# 05-01 §5 — DHCP 는 BOOTP 를 대체한 것이 아니라 그 위에 얹힌 확장이다.
...
W, H = 940, 560
d = D(W, H, "PACKET ANALYSIS WITH WIRESHARK · 05-01 §5",
      "BOOTP 위에 얹힌 DHCP",
...
LAYERS = [
    ("L3", "DHCP 옵션 확장", "RFC 2131 · 1993 · 임대(lease) · 확장 가능한 options", ACC, True),
...
d.t(44, Y0 + 20, "확장 ↑", 9, SOFT, MONO, "start")
d.line(60, Y0 + 32, 60, Y0 + 2 * STRIDE + LH, RULE, 1.0, "3 6")
d.t(44, Y0 + 2 * STRIDE + LH + 4, "전송 ↓", 9, SOFT, MONO, "start")
