...
learning:
  ...
  next_lesson: "1장 Phase 4 자답이 먼저이고 그다음이 2장 Phase 4 입니다. 1장의 남은 축은 스위치가 MAC 테이블로 포트를 가르는 것과 캡처 전 다섯 관문이며, 실습에서 확인된 멀티캐스트 예외를 함정 축 재료로 씁니다. 2장은 Phase 1·3 을 2026-09-14 에 마쳤고 자답만 남았습니다 — 캡처 필터의 비가역성, 두 필터의 문법 차이, 해석 경로 셋(휴리스틱·포트·Decode As)이 출제 축입니다"
updated: 2026-09-14
---
