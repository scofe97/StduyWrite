...
| [05-03 실습 — 주소와 이름을 직접 잡기](./05-03.%EC%8B%A4%EC%8A%B5%20%E2%80%94%20%EC%A3%BC%EC%86%8C%EC%99%80%20%EC%9D%B4%EB%A6%84%EC%9D%84%20%EC%A7%81%EC%A0%91%20%EC%9E%A1%EA%B8%B0.md) | 5장 실습편 골격 — 리눅스 컨테이너 일곱과 `dnsmasq` 로 만든 3묶음 18단계. 묶음 A 는 DORA 와 옆자리 캡처·서버 꺼짐·갱신과 반납·DHCPv6, 묶음 B 는 서버 두 대·NAK·풀 소진·주소 충돌의 두 확인·릴레이, 묶음 C 는 이름 실패 대 연결 실패·질의 타입과 CNAME·EDNS(0)·http.time·재조립·평문 POST 와 CONNECT 터널·DoT·mDNS. 실측 값은 묶음마다 채웁니다 |
