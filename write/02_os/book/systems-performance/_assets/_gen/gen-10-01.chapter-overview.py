...
BANDS = [
    ...
    ("§2", "라우팅 · 캡슐화 · 패킷 크기", "MTU · 프레임 · TCP 페이로드", "경로와 크기를 정한다", None),
    ("§3", "지연 여섯 가지", "이름 해석 · ping · 연결 · TTFB · RTT · 수명", "어디가 느린지 좁힌다", ACC),
    ("§4", "버퍼링 · 백로그", "송수신 버퍼 · 두 윈도 · SYN 큐 · accept 큐", "과하면 되레 느려진다", None),
...
d.legend(Y0 + 5 * STRIDE + 24, [("이 편의 중심 — 지연을 나눠 재는 절", ACC), ("나머지 절", MUTED)])
