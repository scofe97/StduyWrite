...
BANDS = [
    ("§1", "인스턴스", "용어 · 튜너블이 된 유형", "골라 쓰고 바꾸는 사양", None),
    ("§2", "수평 확장", "작은 인스턴스를 병렬로", "잘게 나눈 사이징", None),
    ("§3", "용량 계획", "자동 스케일링과 그 함정", "부하에 반응하는 증감", None),
    ("§4", "스토리지", "휘발성 로컬 · 영속 네트워크", "네트워크 너머의 지연", None),
    ("§5", "멀티테넌시 · Kubernetes", "noisy neighbor · 오케스트레이션", "공유가 부르는 경합", ACC),
]
...
d.t(BX, Y0 + 5 * STRIDE + 18, "가상화 유형 자체(하드웨어·OS·경량) → 11-02~11-04", 13, MUTED, KR, "start")
