...
BANDS = [
    ...
    ("§4", "Linux 네트워크 스택", "SYN 큐 · accept 큐 · 버퍼 · GSO/TSO/GRO", "오버헤드를 줄인다", ACC),
    ("§5", "CPU 스케일링 · 커널 바이패스", "RSS/RPS/RFS/XPS · NAPI · XDP · DPDK", "패킷율을 끌어올린다", None),
]
...
d.legend(Y0 + 5 * STRIDE + 24, [("커널이 오버헤드를 줄이는 절", ACC), ("나머지 절", MUTED)])
