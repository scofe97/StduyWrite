...
d.t(X0, 336, "§1~§5 는 전용 캐시 쪽이고 §6·§7 은 slab 자체를 벗어나는 쪽입니다. 가르는 기준은 물리 연속이 필요한가입니다.", 13, MUTED, KR, "start")
d.t(X0, 360, "전용 캐시를 만들어도 요청한 크기가 그대로 오지는 않습니다 — §4 가 그것을 재는 자리입니다.", 13, SOFT, KR, "start")
