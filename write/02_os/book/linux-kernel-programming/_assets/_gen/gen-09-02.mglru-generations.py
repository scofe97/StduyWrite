...
# 본문이 요구한 형태: "min_gen_nr(가장 차갑고 오래됨·회수 후보)부터 max_gen_nr(가장 뜨거움)까지".
...
# MGLRU — 세대 넷
GENS = [("max_gen_nr", "가장 젊음 · 방금 접근했습니다", INFO),
        ("max_gen_nr - 1", "", INFO),
        ("min_gen_nr + 1", "", WARN),
        ("min_gen_nr", "가장 오래됨 · 회수 후보", ACC)]
...
d.t(24, BOT + 104, "세대 번호는 단조 증가합니다 — 번호가 낮은 쪽이 오래된 쪽이라 회수는 min_gen_nr 부터 합니다.", 13, SOFT, KR, "start")
