...
d.t(X0, 356, "§1 은 내가 고르는 쪽이고 §2~§5 는 커널이 알아서 하는 쪽입니다. 둘이 만나는 자리가 할당 실패입니다.", 13, MUTED, KR, "start")
d.t(X0, 380, "이 회수 기술들이 충분히 못 거두면 다음 노트(09-03)의 OOM killer 가 옵니다.", 13, SOFT, KR, "start")
