...
d.t(X0, 356, "§1~§4 가 계층의 동작이고 §5·§6 이 그 계층을 써도 남는 낭비를 재는 법입니다.", 13, MUTED, KR, "start")
d.t(X0, 380, "slab 을 쓴다고 안심하지 말고 ksize() 로 실제 할당된 양을 확인하라는 것이 이 편의 교훈입니다.", 13, SOFT, KR, "start")
