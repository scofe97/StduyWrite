...
d.t(X0, 356, "§1 의 사실 하나가 나머지를 다 끌고 옵니다 — 예약과 할당이 갈려 있으니 과약속이 가능하고, 과약속했으니 OOM 이 생깁니다.", 13, MUTED, KR, "start")
d.t(X0, 380, "§6 은 그 상황을 사후에 수습하는 대신 미리 가두는 쪽입니다.", 13, SOFT, KR, "start")
