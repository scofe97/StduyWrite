...
packet(RX, 126, "NAT 이 출발지를 바꿔 적음",
...
# 들어오는 길
packet(RX, 344, "웹 서버가 그대로 되돌려 보냄",
       "src 128.119.40.186:80  dst 138.76.29.7:5001")
packet(LX, 344, "NAT 이 목적지를 되돌림",
...
d.t(470, 308, "이 한 줄이 왕복을 이어 줌", 11, MUTED, KR, "middle")

# 표가 두 방향의 값을 공급한다
d.path("M 614 288 L 700 288 L 700 186", ACC, 1.2, m="acc", dash="5 4")
d.path("M 326 288 L 250 288 L 250 338", ACC, 1.2, m="acc", dash="5 4")

d.t(24, 418, "웹 서버는 상대가 집 안의 어느 기기였는지 끝내 알지 못함 — 새 출발지 포트 5001 이 그 사실을 감춤", 11, MUTED, KR, "start")
