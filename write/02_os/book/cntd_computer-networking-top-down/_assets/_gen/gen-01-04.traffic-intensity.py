...
d.t(xpx(0.95) - 10, PY0 + 18, "La/R > 1 이면 큐가 끝없이 자람", 11, BAD, KR, "end")

d.t(PX0 - 106, 486, "원문의 황금률 — 트래픽 강도가 1 을 넘지 않도록 시스템을 설계하십시오. 늘 막히는 도로에 평소보다 조금 더 몰리면 지연이 크게 뛰는 것과 같음",
     11, MUTED, KR, "start")
