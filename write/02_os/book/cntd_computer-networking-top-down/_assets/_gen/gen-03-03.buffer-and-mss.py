...
d.t(44, 200, "3-way 핸드셰이크 때 마련됨", 11, MUTED, KR, "start")
for i in range(5):
    x = 44 + i * 44
...
d.t(44, 292, "MSS ", 11, ACC, KR, "start", 600)
...
d.t(44, 450, "이름이 헷갈림", 12, INK, KR, "start", 600)
d.t(44, 472, "MSS 는 「최대 세그먼트 크기」인데 실제로 세는 것은 세그먼트가 아니라 그 안의 애플리케이션 데이터 · 굳어진 이름이라 그냥 안고 감",
    11, MUTED, KR, "start")
d.t(44, 492, "그래서 MTU 1,500 과 MSS 1,460 의 차이 40 이 IP 헤더 20 과 TCP 헤더 20", 11, WARN, KR, "start")

d.tone(24, 518, W - 48, 62, INFO, 6, "10", 1.2)
d.t(44, 544, "그 버퍼는 양 끝에만 있음", 12, INFO, KR, "start", 600)
d.t(44, 566, "연결은 한쪽 호스트의 버퍼·변수·소켓과 다른 쪽의 버퍼·변수·소켓 · 사이의 라우터·스위치·중계기에는 어떤 버퍼도 변수도 할당되지 않음",
    11, MUTED, KR, "start")
