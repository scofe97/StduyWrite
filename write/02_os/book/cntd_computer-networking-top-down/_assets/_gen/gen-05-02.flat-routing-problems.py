...
d.t(500, 392, "그림에는 12개뿐이지만 오늘날 인터넷의 라우터는 수억 개입니다", 12, MUTED, KR)

# 무너지는 두 자리 — 해결 그림의 두 칸과 줄 단위로 짝이 맞는다
CARDS = [
    (20, "규모", "라우터 수억 개를 감당하지 못합니다",
     ["모든 목적지 정보를 저장하면 메모리가 막대해집니다",
      "변화가 생길 때마다 전부에게 브로드캐스트합니다",
      "거리 벡터는 이 규모에서 수렴하지 못합니다"]),
    (516, "관리 자율성", "주인마다 사정이 다릅니다",
     ["ISP 는 자기 망을 자기 뜻대로 운영하고 싶습니다",
      "쓸 라우팅 알고리즘을 스스로 고르고 싶습니다",
      "내부 구조를 밖에 보이고 싶지 않습니다"]),
]
