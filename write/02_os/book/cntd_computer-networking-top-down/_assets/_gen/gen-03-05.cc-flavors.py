...
d.t(746, 244, "표준으로 배포된 것이 없음", 11, SOFT, KR)

d.t(20, 522, "손실은 버퍼가 넘친 뒤에야 생김 → 알았을 때는 늦음 · 지연 기반과 망 보조는 그 늦음을 앞당기려는 시도",
     11, MUTED, KR, "start")
d.t(20, 544, "무선처럼 혼잡이 아닌 이유로 손실이 나는 경로에서는 손실 기반이 멀쩡한데도 물러섬 · BBR 이 그 함정을 피함",
     11, MUTED, KR, "start")
