...
nx = app_box(508, "Netflix",
             [("비디오 서버", "저장하고 전송함"), ("과금·관리 서버", "클라이언트 기능을 관리함"),
...
d.t(44, 484, "일부는 RFC 로 공개돼 누구나 따를 수 있고, Zoom 처럼 독점인 것도 많음", 11, MUTED, KR, "start")

d.line(24, 530, 976, 530, RULE, 0.8)
d.t(24, 554, "DASH 는 서버와 클라이언트가 주고받는 메시지의 형식과 순서를 정할 뿐 · Netflix 는 그보다 큼",
    11, MUTED, KR, "start")
