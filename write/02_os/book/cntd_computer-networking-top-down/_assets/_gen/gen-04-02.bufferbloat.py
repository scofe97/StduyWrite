...
ROWS = [
    ...
    ("ACK 가 부른 새 패킷", 400, 480, ACC, True, "나간 만큼 들어옴"),
]
...
d.t(xp(440), QY + 26 - 5 * 1.6 + 22, "여기서부터 줄지 않음", 12, ACC, KR)

d.t(20, 414, "정상 상태 큐 = 윈도 − 대역폭·지연 곱 = 25 − 20 = 5 → 그 지연이 상주",
     11, MUTED, KR, "start")
d.t(20, 436, "파이프는 꽉 참 · 손실 없음 · 그래도 +100 ms 상시 — 버퍼블로트",
     11, MUTED, KR, "start")
d.t(20, 466, "원문 RTT 200 ms → t=200 에 11번째 전송 중이라 큐가 15 여야 함",
     11, SOFT, KR, "start")
d.t(20, 488, "원문 결론('21번째·큐 다섯')과 맞는 값은 400 ms — 이 그림도 400 ms",
     11, SOFT, KR, "start")
