...
d.t(24, 476, "셋을 잇달아 보냄", 11, MUTED, KR, "start")
...
d.t(44, 662, "링크는 그대로", 12, INK, KR, "start", 600)
d.t(44, 684, "바뀐 것은 '확인을 받고 나서 다음을 보낸다'는 규칙 하나 · 그 규칙을 풀면 같은 30 ms 안에 셋이 들어가고,",
    11, MUTED, KR, "start")
d.t(44, 702, "이용률도 그만큼 오름 · 대가는 순서 번호 범위·양쪽 버퍼·오류 대응 셋 — 그것이 GBN 과 SR 을 가름",
    11, MUTED, KR, "start")
