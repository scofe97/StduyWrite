...
d = D(W, H, "COMPUTER NETWORKING TOP-DOWN · 03-05 §2",
      ...
      "축에 눈금을 두지 않은 것은 원문과 같음 — 값이 아니라 모양이 요점입니다")
...
d.t(20, 486, "AIMD — 왕복마다 1 MSS 를 더하고(가산 증가) 손실 때 절반으로 나눕니다(승산 감소). 이 규칙이 톱니를 만듦",
     11, MUTED, KR, "start")
d.t(20, 508, "평균 처리량 = 0.75 · W / RTT — 분모가 RTT 라 왕복이 짧은 연결이 같은 병목에서 더 가져감",
     11, MUTED, KR, "start")
