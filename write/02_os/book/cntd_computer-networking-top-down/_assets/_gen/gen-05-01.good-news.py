...
cut(170, "1. 사고 직전", 4, None, "4", "5", set(),
    "y 는 직통 4 · z 는 y 를 거쳐 5")
cut(390, "2. c(y,x) 가 1 로 내려갑니다 — y 가 알림", 1, 'y2z', "1", "5", {'y'},
    "y — min{1+0, 1+5} = 1 · 값이 바뀌어 z 에게 전송")
cut(610, "3. z 가 고쳐 알리면 끝남", 1, 'z2y', "1", "2", {'z'},
    "z 는 min{50, 1+1} = 2 로 내려 y 에게 보냄 · y 는 받아도 바뀔 것이 없어 아무 말도 하지 않음")

d.t(24, 748, "값이 내려갈 때는 남의 옛 값에 기대지 않음 — 자기 직통이 싸진 사실만으로 답 · 두 번의 반복으로 종료", 11, INFO, KR, "start")
