...
#   "4번 라우터까지의 세 값 0.351 · 0.392 · 0.380 밀리초에는 전송·전파·처리·큐잉 지연이 모두 들어 있음."
...
d.t(636, 276, "← 이 칸 하나가 열 배를 만듦", 11, ACC, KR, "start")
d.t(636, 294, "대서양 횡단 광케이블", 11, MUTED, KR, "start")
d.t(752, 500, "↑ 큐잉 칸만 지날 때마다 다릅니다 — 그래서 12번이 11번보다 작음", 11, WARN, KR, "middle")

d.box(24, 532, W - 48, 116, PAPER2, RULE, 0.9, 6)
d.t(44, 558, "예제 출력이 실제로 보여 주는 것 셋", 12, INK, KR, "start", 600)
d.t(44, 580, "4번 라우터까지의 세 값 `0.351 · 0.392 · 0.380 ms` 에는 네 성분이 모두 들어 있음 · 왕복 하나에 넷이 다 섞여 돌아옴",
    11, MUTED, KR, "start")
d.t(44, 602, "`12번`이 `11번`보다 작게 나옴 · 뒤 홉이 앞 홉보다 빠를 수 있다는 뜻이고, 그렇게 만드는 것은 큐잉 하나뿐",
    11, WARN, KR, "start")
d.t(44, 624, "`7번 7.311 ms` 에서 `8번 77.826 ms` 로 열 배 넘게 뜀 · 거리가 뛰었기 때문이고, 거리에 달린 성분은 전파 하나",
    11, ACC, KR, "start")
