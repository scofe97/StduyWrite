...
d.t(28, 486, "창 = 가운데 두 열 = N. 타임아웃이 나면 두 번째 열 전체를 다시 보냄 — 이름이 Go-Back-N 인 이유",
     11, MUTED, KR, "start")
d.t(28, 508, "ACK n 은 누적 · n 이하가 전부 도착했다는 뜻이라, ACK 하나가 오면 창이 그만큼 통째로 미끄러짐",
     11, MUTED, KR, "start")
d.t(28, 530, "창을 N 으로 제한하는 이유는 둘입니다 — 받는 쪽의 버퍼(흐름 제어)와 망의 혼잡(혼잡 제어)",
     11, SOFT, KR, "start")
