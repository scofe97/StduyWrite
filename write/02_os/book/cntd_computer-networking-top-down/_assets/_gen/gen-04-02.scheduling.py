...
for g in range(0, TMAX + 1, 3):
    ...
    d.t(xp(g), 132, str(g), 11, MUTED, MONO)
...
d.legend(H - 32, [("높은 우선순위", ACC), ("클래스 1", INFO), ("클래스 2", OK), ("구분 없음", MUTED)])
