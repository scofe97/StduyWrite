...
d.t(X0, Y + CH + 68, "전송 지연 = 라우터가 패킷을 밀어내는 시간 · 전파 지연 = 비트 하나가 건너가는 시간 — 달린 것이 서로 다름",
     11, MUTED, KR, "start")
