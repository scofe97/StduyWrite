...
d.t(84, 518, "계층 밖이되 DNS 구조에 중심적 · ISP 마다 하나씩 · 보통 DHCP 로 주소를 받음", 11, SOFT, KR, "start")
d.t(916, 496, "질의 대부분이 여기서 끝남", 11, INFO, KR, "end")

d.t(20, 452, "캐싱 덕분에 아주 작은 비율의 질의만이 루트 서버까지 갑니다 — 로컬 서버가 TLD 주소를 캐시해 꼭대기를 건너뜀",
     11, MUTED, KR, "start")
