...
panel(20, "회차 N — 반시계로 몰려 있습니다", 'ccw',
      "시계 쪽이 비어 공짜입니다. 다음 회차에 다들 그리로 갑니다.")
panel(540, "회차 N+1 — 시계로 몰려 있습니다", 'cw',
      "이번엔 반시계가 비어 공짜입니다. 그다음 회차에 되돌아갑니다.")
...
d.t(20, 596, "y 가 시계로 옮기면 x-w 링크가 그만큼 비싸지고, 비어 버린 y-z·z-w 는 그 순간 싸집니다. 다음 회차에 그것을 본 셋이 다 같이 되돌아갑니다.", 11, MUTED, KR, "start")
d.t(20, 618, "모두가 같은 값을 보고 같은 판단을 내리므로 함께 움직이고, 함께 움직이니 옮겨 간 자리가 곧바로 비싸집니다.", 11, MUTED, KR, "start")
d.t(20, 640, "처방은 링크 광고 시각에 무작위를 섞는 것입니다. 따로 돌기 시작해도 결국 발이 맞아 버리기 때문입니다(자기 동기화).", 11, INFO, KR, "start")
