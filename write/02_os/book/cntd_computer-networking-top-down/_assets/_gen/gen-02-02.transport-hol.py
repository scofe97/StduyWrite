...
d.t(24, 464, "HTTP/2 는 프레임을 섞어 앞 객체가 뒤 객체를 막는 일을 없앴습니다.",
     13, MUTED, KR, "start")
d.t(24, 486, "그런데 TCP 는 바이트 스트림 하나라, 하나가 빠지면 뒤에 쌓인 것을 스트림과 무관하게 붙듭니다.",
     13, MUTED, KR, "start")
d.t(24, 508, "같은 형태가 04-02 의 입력 큐에도 있습니다. 앞의 것이 못 나가면 뒤도 못 나갑니다.",
     13, SOFT, KR, "start")
