...
d = D(W, H, "SECTION 5.4.4 · IP ANYCAST",
      ...
      "같은 루트 DNS 주소로 여러 날 물었을 때 대답한 기계. 198.41.0.4 는 도쿄의 세 기계가, 192.5.5.241 은 서울과 인천의 기계가 답했다. "
      "인스턴스마다 같은 주소를 BGP 로 광고하고 경로 위 라우터가 그중 하나로 가는 경로를 고르기 때문이다.",
...
d.t(24, 516, "주소는 그대로인데 대답한 기계가 바뀝니다.", 13, INK, KR, "start", 600)
d.t(24, 540, "인스턴스마다 같은 주소를 BGP 로 광고합니다. 라우터는 그 광고들을 한 곳으로 가는 여러 경로로 보고 하나를 고릅니다.", 13, MUTED, KR, "start")
