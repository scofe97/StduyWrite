...
d.t(TX0 - 210, BOT + 98, "1 Gbps 링크를 깔아 놓고 267 kbps 를 씀", 11, SOFT, KR, "start")

d.t(20, 448, "해법은 창을 여는 것 · 셋을 미리 보내면 이용률이 세 배가 되고, 창이 대역폭·지연 곱만큼 크면 링크를 다 씀",
     11, MUTED, KR, "start")
d.t(20, 470, "여기서는 30 ms 왕복의 1 Gbps 링크라 3.75 메가바이트가 공중에 떠 있어야 링크가 놀지 않음",
     11, MUTED, KR, "start")
