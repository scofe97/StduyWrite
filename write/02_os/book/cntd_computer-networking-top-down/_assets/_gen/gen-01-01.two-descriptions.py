...
d = D(W, H, "COMPUTER NETWORKING TOP-DOWN · 01-01 §1",
      ...
      "아래쪽은 부품이 맡고 위쪽은 애플리케이션이 맡습니다 — 경계에 규칙이 하나 있음")
...
for i, line in enumerate(["호스트 190억 대", "링크와 패킷 스위치", "ISP 가 묶음", "IP · RFC · IEEE 802"]):
    d.t(316, 258 + i * 26, line, 11, MUTED, KR)
for i, line in enumerate(["분산 애플리케이션", "종단에서만 돔", "서비스를 골라 씀", "코어는 관심이 없음"]):
...
d.t(24, 486, "원문의 우편 비유 — 앨리스는 편지를 창밖으로 던지지 않고 봉투에 넣고 주소를 쓰고 우표를 붙여 우체통에 넣음",
     11, MUTED, KR, "start")
