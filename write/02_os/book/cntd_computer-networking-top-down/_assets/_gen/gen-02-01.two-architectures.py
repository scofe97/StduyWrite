...
d.chip(258, 340, "서로 말을 걸지 않음", BAD)

d.tone(44, 356, 428, 36, WARN, 6, "10", 1.0)
d.t(60, 379, "규모가 커지면 데이터센터 — 전기·관리와 대역폭 비용이 계속 나감", 11, WARN, KR, "start")
...
d.t(742, 342, "피어끼리 직접 주고받음", 11, MUTED, KR)

d.tone(528, 356, 428, 36, ACC, 6, "12", 1.4)
d.t(544, 379, "자기 확장성 — 사용자가 늘면 부하와 용량이 같이 늠", 11, ACC, KR, "start")

# ── 결론
d.line(24, 432, 976, 432, RULE, 0.8)
d.t(24, 456, "자기 확장성과 비용 이점을 다 적어 놓고도 결론은 클라이언트-서버", 12, INK, KR, "start")
d.t(24, 478, "P2P 의 고도 분산 구조 → 보안·성능·신뢰성의 도전", 11, MUTED, KR, "start")
