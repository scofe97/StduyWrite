...
cut(170, "1. 사고 직전 — 각자 제 갈 길로 갑니다", 4, 'x', 'y', "4", "5", False,
    "y 는 직통 링크로 바로 갑니다. z 는 y 를 거쳐 5 입니다. 화살표가 마주 보지 않습니다.")
cut(390, "2. c(y,x) 가 60 으로 오릅니다 — 두 화살표가 마주 봅니다", 60, 'z', 'y', "6", "7", True,
    "y 는 z 가 마지막에 말한 5 를 믿고 min{60, 1+5} = 6 을 냅니다. 그런데 z 는 여전히 y 를 거칩니다. x 로 갈 패킷이 둘 사이를 오갑니다.")
cut(610, "3. z 가 직통으로 돌아섭니다 — 루프가 풀립니다", 60, 'z', 'x', "51", "50", False,
    "y 를 거치는 값이 직통 50 을 넘어선 순간 z 가 방향을 바꿉니다. 그때까지 둘은 번갈아 2 씩 올렸습니다.")
