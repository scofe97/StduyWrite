...
d.t(30, 548, "s2 는 아무것도 하지 않았는데도 표가 바뀝니다. s1 이 s4 를 거쳐 보내게 되므로 s2 는 이제 s4 에서 받고,", 11, MUTED, KR, "start")
d.t(30, 568, "s4 는 s1 이 s2 로 보내는 패킷을 나르게 됩니다. 한 곳에서 계산하니 세 스위치가 한꺼번에 맞춰집니다.", 11, MUTED, KR, "start")
