...
d.msg("송신자", "수신자", "seq 1000 · 1차", 206, MUTED, sub="t = 0 — 처음 보냄")
d.selfmsg("송신자", "timeout", 264, WARN, sub="기다려도 ACK 가 오지 않음")
d.msg("송신자", "수신자", "seq 1000 · 2차", 322, WARN, sub="t = 100 — 번호는 1차와 똑같음")
d.msg("수신자", "송신자", "ACK 1500", 380, BAD, sub="t = 120 — 몇 번째 전송의 답인지 적혀 있지 않음")
...
d.t(44, 498, "진짜 값", 11, MUTED, KR, "start")
...
d.t(526, 498, "여섯 배 낮게 잡힘", 11, BAD, KR, "start")

d.box(24, 528, W - 48, 92, PAPER2, RULE, 0.9, 6)
d.t(44, 554, "낮게 잡히면 악순환이 됨", 12, INK, KR, "start", 600)
d.t(44, 576, "추정값이 내려가면 타임아웃도 따라 내려가고, 짧아진 타임아웃이 또 성급한 재전송을 부름 · 재전송이 재전송을 부르는 자리",
    11, MUTED, KR, "start")
d.t(44, 598, "그래서 재전송된 세그먼트는 1차로도 2차로도 재지 않음 · 대신 타임아웃이 날 때마다 값을 두 배로 늘려 보수적으로 물러섬",
    11, OK, KR, "start")
