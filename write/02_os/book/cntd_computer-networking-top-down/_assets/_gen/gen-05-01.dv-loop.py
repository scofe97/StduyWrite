...
STATIONS = [
    ...
    ("벨만-포드 재계산", "더해 보고 최소를 고름", "내 벡터 갱신"),
    ("다음 홉 갱신", "최소를 낸 이웃이 v*", "전달 표 기록"),
    ("이웃에 전파", "바뀌었을 때만 보냄", None),
]
N = len(STATIONS)
FOCAL = 2
...
d.t(30, 674, "대기와 전파는 표를 읽기만 함 · 표를 고쳐 쓰는 것은 가운데로 향한 세 바큇살뿐이고, 그 셋이 아무것도 바꾸지 못하는 바퀴가 오면 전파가 멈춤", 11, MUTED, KR, "start")
