...
d.t((300 + OX) / 2, Y1 - 14, "건넘", 12, OK, KR)

d.path(f"M {300 + PW/2 + 6} {Y2} L {480} {Y2} L {480} {Y1 + 34}", WARN, 1.5, m="warn", dash="5 4")
d.t(500, Y2 - 14, "같은 출력을 노려 막힘", 12, WARN, KR, "start")

d.path(f"M {206} {Y2 + PH/2 + 4} L {206} {Y2 + 54} L {OX - 86} {Y2 + 54} L {OX - 86} {Y2 + 24}",
       ACC, 1.5, m="acc", dash="4 4")
d.t(300, Y2 + 44, "출력 2 는 비어 있는데도 B2 가 함께 기다림", 12, ACC, KR, "start")

d.t(24, 452, "이것이 HOL 블로킹 · 줄 맨 앞이 막히면 뒤에 선 것도 자기 길이 열려 있는지와 무관하게 멈춤",
     11, MUTED, KR, "start")
d.t(24, 474, "도착률 58% → 입력 큐 무한 · 닫힌 형태 2 − √2 = 0.5858",
     11, MUTED, KR, "start")
d.t(24, 496, "절반 조금 넘겨 무너짐 → 링크를 절반 남짓만 사용",
     11, SOFT, KR, "start")
