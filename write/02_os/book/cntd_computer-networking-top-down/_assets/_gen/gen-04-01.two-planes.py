...
for zx, title in zip(ZX, ("전통적 방식 — 제어 평면이 라우터마다 안에", "SDN — 원격 컨트롤러가 계산해 내려보냄")):
...
d.t(256, 268, "라우팅 메시지 교환 → 각자 테이블 계산", 12, INFO, KR)
d.t(256, 200, "제어 평면과 데이터 평면이", 12, MUTED, KR)
d.t(256, 220, "한 상자 안에 함께", 12, MUTED, KR)
...
d.t(744, CTY + 48, "테이블을 계산해 내려보냄 · 소프트웨어", 12, SOFT, KR)
...
d.t(24, 540, "데이터 평면은 두 방식이 동일 — 갈리는 것은 표를 누가 계산하느냐", 13, MUTED, KR, "start")
