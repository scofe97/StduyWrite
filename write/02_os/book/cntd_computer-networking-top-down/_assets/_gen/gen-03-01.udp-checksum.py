...
d.t(24, 400, "링크 층도 검사하는 마당에 왜 또? — 모든 링크의 검사는 보장 안 됨 · 라우터 메모리에서도 비트가 뒤집힘",
     11, MUTED, KR, "start")
d.t(24, 422, "종단 간 원칙 — 낮은 층에 놓인 기능은 높은 층에서 그것을 제공하는 비용에 비해 중복이거나 값이 거의 없을 수 있음",
     11, MUTED, KR, "start")
d.t(24, 452, "UDP 는 오류를 검출만 하고 회복은 하지 않음 · 구현에 따라 손상된 세그먼트를 버리거나 경고와 함께 올려 줌",
     11, SOFT, KR, "start")
