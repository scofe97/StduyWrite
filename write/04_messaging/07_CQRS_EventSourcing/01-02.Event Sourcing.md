...
> - **트레이드오프**: 스냅샷 정책·이벤트 스키마 진화·디버깅 도구 비용. 도입 전 [`08_advanced/01_variants/01-04.스키마 거버넌스`](../08_advanced/01_variants/01-04.스키마%20거버넌스.md)의 호환성 자동화가 선행 조건.
...
- [07-01.Kafka CQRS](06-01.Kafka%20CQRS.md) — Event Sourcing과 자주 결합되는 짝
- [06-01.Kafka Streams](../06_StreamProcessing/01-01.Kafka%20Streams.md) — 이벤트 재생으로 read 모델 생성
- [02-01.EIP Message Pattern](../02_MessageContract/01-01.EIP%20Message%20Pattern.md) — 도메인 이벤트의 의미와 의도
- [05-03.Outbox](../05_ConsistencyPattern/01-03.Outbox.md) — 이벤트 발행 안전 보장
