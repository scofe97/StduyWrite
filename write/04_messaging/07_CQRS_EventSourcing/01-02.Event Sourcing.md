...
- [07-01.Kafka CQRS](01-01.Kafka%20CQRS.md) — Event Sourcing과 자주 결합되는 짝
- [01-01.Kafka Streams](../06_StreamProcessing/01-01.Kafka%20Streams.md) — 이벤트 재생으로 read 모델 생성
- [01-01.EIP Message Pattern](../02_MessageContract/01-01.EIP%20Message%20Pattern.md) — 도메인 이벤트의 의미와 의도
- [02-01.Outbox](../05_ConsistencyPattern/02-01.Outbox.md) — 이벤트 발행 안전 보장
