...
- [01-01.Kafka Streams](../06_StreamProcessing/01-01.Kafka%20Streams.md) — Streams로 만드는 read 모델
- [07-02.Event Sourcing](01-02.Event%20Sourcing.md) — CQRS와 자주 결합되는 짝
- [01-01.EIP Message Pattern](../02_MessageContract/01-01.EIP%20Message%20Pattern.md) — Command·Event 분류
- [02-01.Outbox](../05_ConsistencyPattern/02-01.Outbox.md) — 쓰기 이벤트의 안전한 발행
