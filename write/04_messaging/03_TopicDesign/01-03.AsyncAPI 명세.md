...
- [02-04.EventEnvelope 적용](../02_MessageContract/01-04.EventEnvelope%20적용.md) — AsyncAPI에서 CloudEvents 헤더를 명세하는 방법
...
- [03-04.한 토픽 다수 message 형태](../02_MessageContract/01-07.한%20토픽%20다수%20message%20형태.md) — 한 채널에 여러 message 정의를 묶는 패턴
