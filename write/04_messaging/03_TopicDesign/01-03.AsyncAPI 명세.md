...
related:
  - ../02_MessageContract/01-04.EventEnvelope 적용.md
  - 01-01.토픽 디자인.md
  - 01-02.토픽 파이프라인.md
...
- [01-04.EventEnvelope 적용](../02_MessageContract/01-04.EventEnvelope%20적용.md) — AsyncAPI에서 CloudEvents 헤더를 명세하는 방법
- [01-01.토픽 디자인](01-01.토픽%20디자인.md) — AsyncAPI `channels`가 가리키는 토픽의 명명 규칙
- [01-02.토픽 파이프라인](01-02.토픽%20파이프라인.md) — operations 그래프로 표현되는 파이프라인
- [02-03.한 토픽 다수 message 형태](../02_MessageContract/02-03.한%20토픽%20다수%20message%20형태.md) — 한 채널에 여러 message 정의를 묶는 패턴
