...
- [01-01.토픽 디자인](01-01.토픽%20디자인.md) — 파이프라인을 만드는 토픽 단위 설계
- [02-03.한 토픽 다수 message 형태](../02_MessageContract/02-03.한%20토픽%20다수%20message%20형태.md) — Filter-Branch 대안으로서의 RecordNameStrategy
- [01-01.Choreography Saga](../05_ConsistencyPattern/01-01.Choreography%20Saga.md) — 파이프라인과 SAGA의 경계
- [01-02.Orchestration Saga](../05_ConsistencyPattern/01-02.Orchestration%20Saga.md) — Diamond 패턴이 자연스럽게 진화하는 구조
- [01-01.Kafka Streams](../06_StreamProcessing/01-01.Kafka%20Streams.md) — Stateful 변환을 위한 도구
