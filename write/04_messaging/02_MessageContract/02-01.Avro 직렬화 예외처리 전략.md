...
- [01-02.Schema Registry](01-02.Schema%20Registry.md) — 호환성 모드와 409 Conflict의 의미
- [01-03.Avro](01-03.Avro.md) — Confluent wire format과 `KafkaAvroSerializer`의 동작
- [01-04.EventEnvelope 적용](01-04.EventEnvelope%20적용.md) — DLT 헤더가 traceparent를 보존하는 방식
- [02-02.Avro 스키마 진화 패턴](02-02.Avro%20스키마%20진화%20패턴.md) — 직렬화 실패를 빌드 단계로 끌어오는 자동화
- [02-01.Outbox](../05_ConsistencyPattern/02-01.Outbox.md) — 트랜잭션 묶음의 본격적 다룸
...
> - **상세**: [`05-01.Spring Kafka DLT와 Producer Config`](../05_ConsistencyPattern/05-01.Spring%20Kafka%20DLT와%20Producer%20Config.md), [`05-02.DlqConsumer`](../05_ConsistencyPattern/05-02.DlqConsumer.md).
