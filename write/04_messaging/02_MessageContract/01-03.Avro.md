...
- [02-01.EIP Message Pattern](01-01.EIP%20Message%20Pattern.md) — Avro 스키마가 코드 외부에서 메시지 의도를 명시하는 방법
- [02-02.Schema Registry](01-02.Schema%20Registry.md) — Confluent wire format의 schema ID를 운반하는 인프라
- [02-04.EventEnvelope 적용](01-04.EventEnvelope%20적용.md) — Envelope 패턴의 실전 구현
- [02-05.Avro 직렬화 예외처리 전략](01-05.Avro%20직렬화%20예외처리%20전략.md) — `AvroSerializationException`을 비재시도로 분류하는 이유
- [02-06.Avro 스키마 진화 패턴](01-06.Avro%20스키마%20진화%20패턴.md) — 필드 추가·삭제의 안전 규칙
...
> - **상세**: [`spring/02-01.Avro Consumer 수신 패턴`](01-08.Avro%20Consumer%20수신%20패턴.md) — 앱 내부 Avro vs 외부 JSON 토픽 분리 전략.
