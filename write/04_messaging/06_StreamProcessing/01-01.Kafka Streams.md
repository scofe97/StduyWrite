...
related:
  - 05-02.Kafka Streams Spring Boot.md
  - ../07_CQRS_EventSourcing/01-01.Kafka CQRS.md
  - ../07_CQRS_EventSourcing/01-02.Event Sourcing.md
...
> - **검토 시**: 분산 스트림(Flink, Materialize) 비교는 [`08_advanced/01_variants/01-03.스트림 처리 진화`](../08_advanced/01_variants/01-03.스트림%20처리%20진화.md).
...
- [06-02.Kafka Streams Spring Boot](05-02.Kafka%20Streams%20Spring%20Boot.md) — Spring Boot 통합
- [07-01.Kafka CQRS](../07_CQRS_EventSourcing/01-01.Kafka%20CQRS.md) — Read Model 구축에 Streams 활용
- [07-02.Event Sourcing](../07_CQRS_EventSourcing/01-02.Event%20Sourcing.md) — 이벤트 재생으로 상태 복원
