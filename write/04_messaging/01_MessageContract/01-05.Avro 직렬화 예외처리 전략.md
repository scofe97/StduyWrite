...
- [02-02.Schema Registry](01-02.Schema%20Registry.md) — 호환성 모드와 409 Conflict의 의미
- [02-03.Avro](01-03.Avro.md) — Confluent wire format과 `KafkaAvroSerializer`의 동작
- [02-04.EventEnvelope 적용](01-04.EventEnvelope%20적용.md) — DLT 헤더가 traceparent를 보존하는 방식
- [02-06.Avro 스키마 진화 패턴](01-06.Avro%20스키마%20진화%20패턴.md) — 직렬화 실패를 빌드 단계로 끌어오는 자동화
- [05-03.Outbox](../04_ConsistencyPattern/04-03.Outbox.md) — 트랜잭션 묶음의 본격적 다룸
...
> - **상세**: [`spring/03-01.Spring Kafka DLT와 Producer Config`](../04_ConsistencyPattern/04-10.Spring%20Kafka%20DLT와%20Producer%20Config.md), [`spring/03-02.DlqConsumer`](../04_ConsistencyPattern/04-11.DlqConsumer.md).
