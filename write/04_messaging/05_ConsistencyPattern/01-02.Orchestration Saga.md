...
- [05-01.Choreography Saga](04-01.Choreography%20Saga.md) — 코레오그래피 대안과 트레이드오프
- [05-03.Outbox](04-03.Outbox.md) — Command·Event 발행의 안전 보장
- [05-05.Inbox](04-05.Inbox.md) — Reply 이벤트 수신 측 멱등성
- [03-01.토픽 디자인](../03_TopicDesign/01-01.토픽%20디자인.md) — Saga 메시지 4분류와 토픽 설계
- [04-08.Exactly-once 의미론과 Consumer Idempotency](04-09.Exactly-once%20의미론과%20Consumer%20Idempotency.md) — Saga에서 효과적 EOS
...
> - **상세**: 외부 엔진(Temporal, Cadence 등)과의 비교는 [`08_advanced/01_variants/01-02.Saga 엔진 비교`](../08_advanced/01_variants/01-02.Saga%20엔진%20비교.md).
