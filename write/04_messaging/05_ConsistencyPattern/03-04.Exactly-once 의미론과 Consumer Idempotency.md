...
- [03-05.Idempotent Producer — PID·시퀀스·중복 방지](03-05.Idempotent%20Producer%20—%20PID·시퀀스·중복%20방지.md) — 발행 측 retry 중복을 Kafka가 자동으로 막는 메커니즘
- [03-06.Kafka Transactions 내부 — Zombie Fencing·2PC](03-06.Kafka%20Transactions%20내부%20—%20Zombie%20Fencing·2PC.md) — EOS의 강한 축, 스트림 처리 트랜잭션 내부
