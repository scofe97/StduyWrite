...
Outbox 패턴 자체의 상세는 [02-01.Outbox](02-01.Outbox.md) 참조.
...
> - **상세**: 본 시리즈의 [`03-04.Exactly-once 의미론과 Consumer Idempotency`](03-04.Exactly-once%20의미론과%20Consumer%20Idempotency.md), TPS 코드 측 계획은 `message-lib/docs/inbox-idempotency-plan.md`.
