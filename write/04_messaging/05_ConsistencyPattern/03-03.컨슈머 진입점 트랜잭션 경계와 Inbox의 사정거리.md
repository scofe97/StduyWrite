...
[01-05](03-01.Inbox.md)가 Inbox 패턴 자체와 Outbox 대칭을 다루고, [01-07](03-02.Inbox%20트랜잭션%20오염과%20멱등%20어댑터.md)이 멱등 INSERT의 트랜잭션 오염 문제를 다룬다면, 본 문서는 그 위에서 **컨슈머 진입점에서 트랜잭션 경계를 어떻게 잡을지** 를 다룬다. 두 결정이 충돌할 때 무엇을 양보해야 하는지가 본문의 중심이다.
...
3안은 [01-07](03-02.Inbox%20트랜잭션%20오염과%20멱등%20어댑터.md)에서 다룬 `INSERT IGNORE` 어댑터를 쓰면 가능하다. 

- 다만 [01-07 §1](03-02.Inbox%20트랜잭션%20오염과%20멱등%20어댑터.md)에서 본 것처럼 호출자가 `@Transactional(MANDATORY)`를 강제하지 않는 한 라이브러리 차원의 "올바른 사용 강제"가 약해진다. 안 2가 그 강제를 보존하면서 트랜잭션을 짧게 가져가는 절충안이다.
...
- [03-01.Inbox](03-01.Inbox.md) — Inbox 패턴 본문과 Outbox 대칭, Idempotent Consumer 비교
- [03-02.Inbox 트랜잭션 오염과 멱등 어댑터](03-02.Inbox%20트랜잭션%20오염과%20멱등%20어댑터.md) — 멱등 INSERT의 트랜잭션 오염과 INSERT IGNORE 어댑터
- [03-04.Exactly-once 의미론과 Consumer Idempotency](03-04.Exactly-once%20의미론과%20Consumer%20Idempotency.md) — at-least-once 위에서 멱등을 만들어내는 일반론
- [02-01.Outbox](02-01.Outbox.md) — 송신 측의 짝이 되는 dual-write 해결 패턴
