...
- [07-02.Kafka 메트릭 카탈로그 — Infra·Broker](04_BrokerArchitecture/07-02.Kafka%20메트릭%20카탈로그%20—%20Infra·Broker.md) — infra 60% 임계, broker MBean(UnderReplicated·UnderMinIsr·NetworkProcessorAvgIdle·ActiveController), 모니터링 허브
- [07-03.Kafka 클라이언트·운영 모니터링](04_BrokerArchitecture/07-03.Kafka%20클라이언트·운영%20모니터링%20—%20Client·Streams·배포환경.md) — producer·consumer(lag/lead)·Connect·Streams 메트릭, 배포환경별 모니터링
