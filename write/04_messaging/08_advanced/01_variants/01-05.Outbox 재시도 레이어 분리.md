...
- [05-03.Outbox](../05_ConsistencyPattern/01-03.Outbox.md) — 폴링 Relay 기본 구현, 트랜잭션 분리, 지수 백오프 SQL이 처음 등장하는 문서
- [05-04.Outbox 스케일링](../05_ConsistencyPattern/01-04.Outbox%20스케일링.md) — TPS 적용 사례 박스에서 두 레이어가 동시 언급되는 출발점
