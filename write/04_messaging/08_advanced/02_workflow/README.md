...
`[05-02.Orchestration Saga](../../05_ConsistencyPattern/01-02.Orchestration%20Saga.md)`가 Saga의 일반 구조를 다뤘고, `[09-02.Saga 엔진 비교](../01_variants/01-02.Saga%20%EC%97%94%EC%A7%84%20%EB%B9%84%EA%B5%90.md)`가 손코딩과 엔진들의 트레이드오프 매트릭스를 제공한다. 본 폴더는 그중 *Temporal* 한 도구를 깊이 들여다보고, EDA + CDC 학습 트리와 어떻게 결합되는지 단계적으로 따라간다.
...
2. Outbox 패턴 — `[05-03.Outbox](../../05_ConsistencyPattern/01-03.Outbox.md)` 수준.
3. CDC와 Debezium 설정 — `[05-06.CDC](../../05_ConsistencyPattern/01-06.CDC.md)` 수준.
4. Saga의 코레오그래피/오케스트레이션 차이 — `[05-01](../../05_ConsistencyPattern/01-01.Choreography%20Saga.md)`, `[05-02](../../05_ConsistencyPattern/01-02.Orchestration%20Saga.md)` 수준.
...
- Debezium 설정과 EventRouter 디테일 — `[05-06.CDC](../../05_ConsistencyPattern/01-06.CDC.md)`
- Outbox 테이블 설계 자체 — `[05-03.Outbox](../../05_ConsistencyPattern/01-03.Outbox.md)`
- Saga 패턴의 일반 구조 — `[05-01](../../05_ConsistencyPattern/01-01.Choreography%20Saga.md)`, `[05-02](../../05_ConsistencyPattern/01-02.Orchestration%20Saga.md)`
