...
related:
  - ../README.md
  - ../../04_ConsistencyPattern/04-02.Orchestration Saga.md
  - ../../04_ConsistencyPattern/04-06.CDC.md
  - ../09_advanced/09-02.Saga 엔진 비교.md
updated: 2026-05-17
---

# 08_workflow — Workflow 오케스트레이션과 통합
...
`[05-02.Orchestration Saga](../04_ConsistencyPattern/04-02.Orchestration%20Saga.md)`가 Saga의 일반 구조를 다뤘고, `[09-02.Saga 엔진 비교](../09_advanced/09-02.Saga%20%EC%97%94%EC%A7%84%20%EB%B9%84%EA%B5%90.md)`가 손코딩과 엔진들의 트레이드오프 매트릭스를 제공한다. 본 폴더는 그중 *Temporal* 한 도구를 깊이 들여다보고, EDA + CDC 학습 트리와 어떻게 결합되는지 단계적으로 따라간다.
...
1. EDA의 기본 모델 — `[01-01.EDA 기초](../../03_architecture/04_edd/05_KafkaApplied/05-01.EDA%20기초.md)` 수준.
2. Outbox 패턴 — `[05-03.Outbox](../04_ConsistencyPattern/04-03.Outbox.md)` 수준.
3. CDC와 Debezium 설정 — `[05-06.CDC](../04_ConsistencyPattern/04-06.CDC.md)` 수준.
4. Saga의 코레오그래피/오케스트레이션 차이 — `[05-01](../04_ConsistencyPattern/04-01.Choreography%20Saga.md)`, `[05-02](../04_ConsistencyPattern/04-02.Orchestration%20Saga.md)` 수준.
...
`[09-02.Saga 엔진 비교](../09_advanced/09-02.Saga%20%EC%97%94%EC%A7%84%20%EB%B9%84%EA%B5%90.md)`는 *엔진 선택* 관점, 본 폴더는 *선택된 엔진의 깊은 운영* 관점으로 직교한다. 새 엔진 문서가 늘어나도 두 폴더의 경계는 흔들리지 않는다.
...
- Debezium 설정과 EventRouter 디테일 — `[05-06.CDC](../04_ConsistencyPattern/04-06.CDC.md)`
- Outbox 테이블 설계 자체 — `[05-03.Outbox](../04_ConsistencyPattern/04-03.Outbox.md)`
- Saga 패턴의 일반 구조 — `[05-01](../04_ConsistencyPattern/04-01.Choreography%20Saga.md)`, `[05-02](../04_ConsistencyPattern/04-02.Orchestration%20Saga.md)`
...
- [../../04_ConsistencyPattern/04-02.Orchestration Saga.md](../04_ConsistencyPattern/04-02.Orchestration%20Saga.md) — Saga 패턴의 일반 구조
- [../../04_ConsistencyPattern/04-06.CDC.md](../04_ConsistencyPattern/04-06.CDC.md) — Debezium CDC 설정
- [../09_advanced/09-02.Saga 엔진 비교.md](../09_advanced/09-02.Saga%20%EC%97%94%EC%A7%84%20%EB%B9%84%EA%B5%90.md) — 엔진 선택 매트릭스
