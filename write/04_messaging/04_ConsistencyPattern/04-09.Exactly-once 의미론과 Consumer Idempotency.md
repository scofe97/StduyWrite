...
related:
  ...
  - 04-03.Outbox.md
  - 04-05.Inbox.md
  - ../05_StreamProcessing/05-02.Kafka Streams Spring Boot.md
updated: 2026-05-16
---
...
- [04-03.Consumer Group](./../03_BrokerArchitecture/03-03.Consumer%20Group.md) — 오프셋 추적, auto.offset.reset 정책
- [05-03.Outbox](./04-03.Outbox.md) — Producer at-least-once 짝
- [05-05.Inbox](./04-05.Inbox.md) — 본 문서의 개념 배경, 외부 API 호출이 끼는 경우의 변형
- [06-02.Kafka Streams Spring Boot](./../05_StreamProcessing/05-02.Kafka%20Streams%20Spring%20Boot.md) — Kafka → Kafka 흐름에서의 EOS 설정
...
- [04-03.Consumer Group](../03_BrokerArchitecture/03-03.Consumer%20Group.md) — 오프셋 커밋과 EOS의 비대칭
- [04-04.리밸런스 프로토콜](../03_BrokerArchitecture/03-04.리밸런스%20프로토콜.md) — 리밸런스 중 중복 처리의 발생 지점
- [05-03.Outbox](04-03.Outbox.md) — 발행 측 멱등성
- [05-05.Inbox](04-05.Inbox.md) — 수신 측 멱등성
- [06-02.Kafka Streams Spring Boot](../05_StreamProcessing/05-02.Kafka%20Streams%20Spring%20Boot.md) — Streams의 EOS 모드
