...
- [04-08.Exactly-once 의미론과 Consumer Idempotency](../05_ConsistencyPattern/01-09.Exactly-once%20의미론과%20Consumer%20Idempotency.md) — 리밸런스 중 오프셋 처리
- [06-01.Kafka Streams](../06_StreamProcessing/01-01.Kafka%20Streams.md) — State Store 재구축 비용이 가장 큰 환경
