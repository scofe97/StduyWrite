...
- [08-01.메시지 정리 — Log Retention·Compaction·Tombstone](08-01.메시지%20정리%20—%20Log%20Retention·Compaction·Tombstone.md) — §1.2~1.3 세그먼트·보존 정책이 log cleaner로 실제 정리되는 메커니즘
