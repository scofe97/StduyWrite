...
- [04-02.리더 선출](03-02.리더%20선출.md) — Quorum 합의와 ZK/KRaft 비교
- [04-03.Consumer Group](03-03.Consumer%20Group.md) — 파티션-Consumer 매핑이 만드는 병렬성
- [04-04.리밸런스 프로토콜](03-04.리밸런스%20프로토콜.md) — Consumer 가입/탈퇴 시 파티션 재분배
- [04-05.Redpanda 아키텍처](03-05.Redpanda%20아키텍처.md) — 같은 추상의 다른 구현
- [04-08.Exactly-once 의미론과 Consumer Idempotency](../05_ConsistencyPattern/01-09.Exactly-once%20의미론과%20Consumer%20Idempotency.md) — Producer 멱등성과 트랜잭션
