...
마지막으로 **Kafka 브로커 SASL/TLS** 도입을 별도 과제로 분리한다. 이건 Console 인증과 무관한 더 큰 작업이지만, 본 문서의 모든 옵션은 어디까지나 UI 게이트라는 사실을 잊지 않기 위해 함께 적어 둔다. 자세한 절차는 [04-07.Kafka·Redpanda SASL 인증](./03-07.Kafka·Redpanda%20SASL%20인증.md)에서 다룬다.
