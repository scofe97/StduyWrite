...
- [04-01.메시지 큐 아키텍처](03-01.메시지%20큐%20아키텍처.md) — 파티션 추상 위에서 리밸런스가 동작
- [04-03.Consumer Group](03-03.Consumer%20Group.md) — JoinGroup/SyncGroup의 기본 흐름
- [04-08.Exactly-once 의미론과 Consumer Idempotency](../04_ConsistencyPattern/04-09.Exactly-once%20의미론과%20Consumer%20Idempotency.md) — 리밸런스 중 오프셋 처리
- [06-01.Kafka Streams](../05_StreamProcessing/05-01.Kafka%20Streams.md) — State Store 재구축 비용이 가장 큰 환경
