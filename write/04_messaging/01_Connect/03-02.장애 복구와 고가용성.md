...
업무 레벨 멱등성 설계에 대한 상세 내용은 Spring Boot 구현 관점에서 다룬 [`04_ConsistencyPattern/03-01.Inbox.md`](../05_ConsistencyPattern/03-01.Inbox.md)를 참조한다.
...
- [04_ConsistencyPattern/03-01.Inbox.md](../05_ConsistencyPattern/03-01.Inbox.md) — 업무 레벨 멱등성
