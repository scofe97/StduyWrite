...
- [`../ch01_java-tech/01-01.Java와 JVM의 성능 진화사`](../ch01_java-tech/03-01.Java와%20JVM의%20성능%20진화사.md) — ZGC·Shenandoah·STW 도입 연대기
- [`../ch02_automatic-memory-management/02-08.저지연 가비지 컬렉터`](./02-08.저지연%20가비지%20컬렉터.md) — 《밑바닥》 쪽 저지연 GC(ZGC·Shenandoah)
- [`../ch02_automatic-memory-management/02-10.GC 선택하기`](./02-10.GC%20선택하기.md) — 《밑바닥》 쪽 GC 선택 기준
