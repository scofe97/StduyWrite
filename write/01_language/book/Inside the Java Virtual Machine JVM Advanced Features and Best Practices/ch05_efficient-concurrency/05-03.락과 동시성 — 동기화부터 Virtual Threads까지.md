...
- [`./05-02.동기화와 NUMA, JMH 벤치마킹`](./05-02.동기화와%20NUMA,%20JMH%20벤치마킹.md) — JMH·atomic·happens-before·CAS
- [`../ch02_automatic-memory-management/02-08.저지연 가비지 컬렉터`](../ch02_automatic-memory-management/02-08.저지연%20가비지%20컬렉터.md) — 동시성과 맞물리는 저지연 GC
- [`./02-03.락 최적화 — 스핀·제거·굵게·경량·편향`](./02-03.락%20최적화%20—%20스핀·제거·굵게·경량·편향.md) — §3 락 최적화 5기법(편향·경량·제거·거칠게·적응적 스핀)의 《밑바닥》 정독 SSOT
- [`./01-05.Virtual Threads 기초`](./01-05.Virtual%20Threads%20기초.md) — §7 virtual thread·continuation의 《자바 동시성》 쪽 기초(carrier·mount/unmount)
- [`./01-05.Virtual Threads 기초`](./01-05.Virtual%20Threads%20기초.md) — §7 carrier pinning의 발생 조건·감지·해결(§11 Pinning)
