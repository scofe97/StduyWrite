...
`testing/`은 "Spring Boot 애플리케이션을 외부에서 검증하는 Python 클라이언트"의 결정을 담는다. Spring 측의 통합 테스트는 [`11_spring/04_testing/`](../../11_spring/04_testing/README.md)에 별도로 있고, 두 묶음은 같은 시스템을 양쪽에서 검증하는 보완 관계다.
