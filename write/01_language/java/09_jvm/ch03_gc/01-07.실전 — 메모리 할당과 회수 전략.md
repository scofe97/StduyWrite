...
tags: [jvm, gc, allocation, eden, survivor, pretenure, tenuring, tlab]
status: draft
related:
  ...
  - ../_code/ch03-gc/allocation/
source: 《JVM 밑바닥까지 파헤치기》(저우즈밍, 위키북스) §3.8
updated: 2026-05-21
---

# 실전 — 메모리 할당과 회수 전략
---
> §3.8은 객체의 일생을 코드로 따라간다. *어디에 할당되는가*, *언제 옮겨지는가*, *언제 승격되는가*를 GC 로그로 관찰한다. 본 노트는 책의 다섯 가지 규칙을 정리하고 각각을 실습 코드로 박제한다.
...
`_code/ch03-gc/allocation/` 폴더에 다섯 규칙의 데모를 박제한다.
