...
- [../java/05_JVM/ch05_efficient-concurrency/02-02.스레드 안전성 구현 — 동기화와 락](../../../java/05_JVM/ch05_efficient-concurrency/02-02.스레드%20안전성%20구현%20—%20동기화와%20락.md) — §3 동시성 약점(race condition·deadlock·starvation)의 Java 메커니즘
