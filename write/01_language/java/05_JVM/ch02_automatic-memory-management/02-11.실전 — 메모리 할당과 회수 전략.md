...
> Eden 우선 할당·큰 객체 직접 Old·age 임계 승격 등, 객체가 어디에 놓이고 언제 승격되는지를 정하는 규칙 다섯 가지다.
...
![객체 할당과 승격의 다섯 규칙](_assets/02-09-allocation-rules.svg)
...
![TestAllocation GC 로그 분석 흐름](_assets/02-09-gc-log-analysis.svg)
...
![공간 보장과 Promotion Failure 흐름](_assets/02-09-promotion-guarantee.svg)
...
![TLAB fast path와 공유 Eden slow path](_assets/02-09-tlab-flow.svg)
...
다음 노트(02-11)는 §3.9 마치며 — 3장이 4장 *GC 모니터링 도구*에 거는 토대를 정리한다.
...
- [02-04.가비지 컬렉션 알고리즘](./02-04.%EA%B0%80%EB%B9%84%EC%A7%80%20%EC%BB%AC%EB%A0%89%EC%85%98%20%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98.md) — 세대별 GC의 전제, 본 노트의 다섯 규칙이 의존하는 *세대별 가설*
- [02-05.핫스팟 알고리즘 상세 구현](./02-05.%ED%95%AB%EC%8A%A4%ED%8C%9F%20%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98%20%EC%83%81%EC%84%B8%20%EA%B5%AC%ED%98%84.md) — TLAB 동시 할당이 OopMap·카드 테이블과 어떻게 맞물리는지
- [02-06.클래식 가비지 컬렉터](./02-06.%ED%81%B4%EB%9E%98%EC%8B%9D%20%EA%B0%80%EB%B9%84%EC%A7%80%20%EC%BB%AC%EB%A0%89%ED%84%B0.md) — 다섯 규칙이 어느 컬렉터에서 어떻게 다르게 적용되는지
- [02-12.마치며](./02-12.마치며.md) — 3장 전체를 묶어 4장 모니터링 도구로 거는 토대
