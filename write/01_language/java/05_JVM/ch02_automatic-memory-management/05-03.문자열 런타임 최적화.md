...
- [`./01-02.락과 동시성 — 동기화부터 Virtual Threads까지`](../ch05_efficient-concurrency/06-03.락과%20동시성%20—%20동기화부터%20Virtual%20Threads까지.md) — 같은 장 후반부: monitor lock·contended locking·virtual thread
...
- [`../ch02_automatic-memory-management/05-01.TLAB·PLAB·NUMA-aware GC와 G1 심화`](./05-01.TLAB·PLAB·NUMA-aware%20GC와%20G1%20심화.md) — G1 dedup이 동작하는 evacuation·marking phase
- [`../ch06_class-file/01-02.바이트코드 명령어`](../ch03_class-loading-mechanism/01-02.바이트코드%20명령어.md) — invokedynamic 등 bytecode 명령
