...
- [`../ch05_efficient-concurrency/06-03.락과 동시성 — 동기화부터 Virtual Threads까지`](../ch05_efficient-concurrency/06-03.락과%20동시성%20—%20동기화부터%20Virtual%20Threads까지.md) — 같은 책 7장 후반부: monitor lock·contended locking·virtual thread
