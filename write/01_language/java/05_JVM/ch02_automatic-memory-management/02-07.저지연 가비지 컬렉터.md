...
![동시 정리와 참조 갱신 분리 흐름](_assets/02-07-concurrent-relocation.svg)
...
![Shenandoah forwarding pointer 흐름](_assets/02-07-shenandoah-forwarding.svg)
...
![ZGC load barrier와 colored pointer 흐름](_assets/02-07-zgc-load-barrier.svg)
...
![저지연 GC 비교 — Shenandoah와 ZGC](_assets/02-07-low-latency-comparison.svg)
...
다음 노트(02-06)는 *어느 컬렉터를 어떤 워크로드에 쓸지* — JDK 버전별 디폴트와 의사결정 트리 — 를 다룬다.
...
- [02-08.GC 선택하기](./02-08.GC%20%EC%84%A0%ED%83%9D%ED%95%98%EA%B8%B0.md) — 저지연 GC가 적합한 워크로드와 그렇지 않은 워크로드의 의사결정
- [02-09.실전 — 메모리 할당과 회수 전략](./02-09.%EC%8B%A4%EC%A0%84%20%E2%80%94%20%EB%A9%94%EB%AA%A8%EB%A6%AC%20%ED%95%A0%EB%8B%B9%EA%B3%BC%20%ED%9A%8C%EC%88%98%20%EC%A0%84%EB%9E%B5.md) — 동시 이동이 가능한 GC에서 *할당 위치*가 갖는 의미
