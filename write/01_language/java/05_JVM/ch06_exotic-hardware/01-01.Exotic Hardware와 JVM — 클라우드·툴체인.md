...
- [`../ch01_java-tech/01-01.Java와 JVM의 성능 진화사`](../ch01_java-tech/03-01.Java와%20JVM의%20성능%20진화사.md) — JVM이 bytecode를 CPU 머신코드로 컴파일하는 범용 모델
- [`../ch01_java-tech/01-01.타입 시스템의 진화와 성능`](../ch01_java-tech/03-02.타입%20시스템의%20진화와%20성능.md) — Vector API와 Project Valhalla
