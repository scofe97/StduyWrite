...
- [`../ch20_jpe-runtime/01-02.락과 동시성 — 동기화부터 Virtual Threads까지`](../ch20_jpe-runtime/01-02.락과%20동시성%20—%20동기화부터%20Virtual%20Threads까지.md) — JIT·de-optimization과 맞물리는 런타임
- [`../ch19_jpe-gc/01-01.TLAB·PLAB·NUMA-aware GC와 G1 심화`](../ch19_jpe-gc/01-01.TLAB·PLAB·NUMA-aware%20GC와%20G1%20심화.md) — Metaspace 가득 찰 때 도는 full GC
