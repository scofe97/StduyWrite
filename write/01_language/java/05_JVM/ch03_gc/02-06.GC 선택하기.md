...
graph TB
    ...
    style T fill:#90EE90,stroke:#333,color:#000
    style L fill:#ADD8E6,stroke:#333,color:#000
    style F fill:#FFE4B5,stroke:#333,color:#000
    style P fill:#90EE90,stroke:#333,color:#000
    style Z fill:#ADD8E6,stroke:#333,color:#000
    style S fill:#FFE4B5,stroke:#333,color:#000
...
- [02-04.클래식 가비지 컬렉터](./02-04.클래식%20가비지%20컬렉터.md) — 본 노트의 의사결정 트리에서 *처리량 우선* 가지가 가리키는 컬렉터들
- [02-05.저지연 가비지 컬렉터](./02-05.저지연%20가비지%20컬렉터.md) — *지연 우선* 가지가 가리키는 ZGC·Shenandoah
- [02-07.실전 — 메모리 할당과 회수 전략](./02-07.실전%20—%20메모리%20할당과%20회수%20전략.md) — 컬렉터 선택 후 *할당 전략*을 코드로 검증하는 다음 단계
