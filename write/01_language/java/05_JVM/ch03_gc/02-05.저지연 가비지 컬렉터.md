...
![동시 정리와 참조 갱신 분리 흐름](_assets/02-05-concurrent-relocation.svg)
...
![Shenandoah forwarding pointer 흐름](_assets/02-05-shenandoah-forwarding.svg)
...
![ZGC load barrier와 colored pointer 흐름](_assets/02-05-zgc-load-barrier.svg)
...
![저지연 GC 비교 — Shenandoah와 ZGC](_assets/02-05-low-latency-comparison.svg)
