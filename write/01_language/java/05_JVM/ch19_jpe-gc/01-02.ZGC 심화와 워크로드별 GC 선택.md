...
- [`../ch03_gc/02-05.저지연 가비지 컬렉터`](../ch03_gc/02-05.저지연%20가비지%20컬렉터.md) — 《밑바닥》 쪽 저지연 GC(ZGC·Shenandoah)
- [`../ch03_gc/02-06.GC 선택하기`](../ch03_gc/02-06.GC%20선택하기.md) — 《밑바닥》 쪽 GC 선택 기준
