...
> **이 책의 위치**: 사용자가 실무에서 주로 쓰는 게 이 Spring Data 계층입니다. 이 책(《Java Performance》)은 그 **아래 깔린 JDBC·JPA 원리**를 SSOT로 다루고, Spring Data 모듈의 구체 설정·repository 패턴·`@Transactional` 전파 등은 10_spring SSOT가 다룹니다. 둘은 같은 주제를 계층으로 나눠 갖습니다.
