...
- [`./03-02.생산자-소비자 패턴.md`](./03-02.생산자-소비자%20패턴.md) — 스레드 협력의 가장 흔한 모델
- [`./04-02.Executor 프레임워크.md`](./04-02.Executor%20프레임워크.md) — `new Thread()`를 직접 만드는 대신 *풀로 관리*하는 권장 방식
- [`./05-01.Virtual Threads 기초.md`](./05-01.Virtual%20Threads%20기초.md) — JDK 21에서 도입된 *경량 스레드*가 본 노트의 OS 스레드 모델을 어떻게 바꾸는지
