...
- [`./05-01.Virtual Threads 기초`](./05-01.Virtual%20Threads%20기초.md) — §7 virtual thread·continuation의 《자바 동시성》 쪽 기초(carrier·mount/unmount)
- [`./05-01.Virtual Threads 기초`](./05-01.Virtual%20Threads%20기초.md) — §7 carrier pinning의 발생 조건·감지·해결(§11 Pinning)
