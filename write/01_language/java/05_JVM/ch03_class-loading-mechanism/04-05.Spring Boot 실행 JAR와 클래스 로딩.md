...
> fat JAR·shaded JAR·slim(thin) JAR가 각각 무엇이고 의존성을 어떻게 담는지는 빌드 관점의 [웹 애플리케이션 빌드 — WAR와 실행 JAR §2.1](../../06_Build/01-02.웹%20애플리케이션%20빌드%20—%20WAR와%20실행%20JAR.md)이 SSOT입니다. 이 절은 그 fat JAR를 컨테이너 레이어로 쪼개는 각도만 다룹니다.
