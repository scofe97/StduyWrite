...
related:
  ...
  - 04-07.Kafka·Redpanda SASL 인증.md
...
> Redpanda는 Kafka API 호환이라는 외부 계약을 그대로 유지하면서, 내부 구현을 *단일 바이너리·Thread-per-Core·Raft*로 다시 짠 메시지 브로커다. 공통 메시지 큐 추상은 [04-01.메시지 큐 아키텍처](./04-01.메시지%20큐%20아키텍처.md)와 [04-02.리더 선출](./04-02.리더%20선출.md)에서 다뤘고, 이 글은 그 위에서 Redpanda 특유의 선택을 살핀다.
...
- [04-01.메시지 큐 아키텍처](04-01.%EB%A9%94%EC%8B%9C%EC%A7%80%20%ED%81%90%20%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98.md) — 공통 추상 (파티션·복제·acks)
- [04-02.리더 선출](04-02.%EB%A6%AC%EB%8D%94%20%EC%84%A0%EC%B6%9C.md) — Raft의 본격적 다룸
- [04-06.Redpanda Console 인증](04-06.Redpanda%20Console%20%EC%9D%B8%EC%A6%9D.md) — Admin API 측 운영 도구
- [04-07.Kafka·Redpanda SASL 인증](04-07.Kafka%C2%B7Redpanda%20SASL%20%EC%9D%B8%EC%A6%9D.md) — Kafka API 측 인증
- [04-10.Kafka 공통 정책 스타터 패턴](04-10.Kafka%20%EA%B3%B5%ED%86%B5%20%EC%A0%95%EC%B1%85%20%EC%8A%A4%ED%83%80%ED%84%B0%20%ED%8C%A8%ED%84%B4.md) — 운영 디폴트 정책
