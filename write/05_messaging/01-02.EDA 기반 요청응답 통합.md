...
- [01-01.EDA 기초](01-01.EDA%20기초.md) — Request/Response 한계와 EDA로의 전환 동기
- [01-03.202 Accepted + Polling 패턴](01-03.202%20Accepted%20+%20Polling%20패턴.md) — 202+Polling의 상세 구현
- [05-03.Outbox](05-03.Outbox.md) — DB와 이벤트 발행의 원자성 보장
- [07-01.Kafka CQRS](07-01.Kafka%20CQRS.md) — CQRS 쓰기·읽기 모델 분리
