...
- [02-01.EIP Message Pattern](02-01.EIP%20Message%20Pattern.md) — Envelope의 이론적 기원과 Command/Event 의도 분류
- [02-02.Schema Registry](02-02.Schema%20Registry.md) — 페이로드 측 계약을 인프라 수준으로 강제
- [02-03.Avro](02-03.Avro.md) — Envelope이 감싸는 페이로드 직렬화
- [03-03.AsyncAPI 명세](03-03.AsyncAPI%20%EB%AA%85%EC%84%B8.md) — Envelope과 Payload를 명세로 노출하는 표준
- [03-04.한 토픽 다수 message 형태](03-04.%ED%95%9C%20%ED%86%A0%ED%94%BD%20%EB%8B%A4%EC%88%98%20message%20%ED%98%95%ED%83%9C.md) — `ce-type` 헤더로 같은 토픽에서 라우팅
...
> - **상세**: [`spring/01-01.CloudEventsHeaderInterceptor`](spring/01-01.CloudEventsHeaderInterceptor.md), [`spring/04-01.trace-id와 traceparent`](spring/04-01.trace-id와%20traceparent.md).
