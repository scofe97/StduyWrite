...
- [02-04.EventEnvelope 적용](02-04.EventEnvelope%20%EC%A0%81%EC%9A%A9.md) — AsyncAPI에서 CloudEvents 헤더를 명세하는 방법
- [03-01.토픽 디자인](03-01.토픽%20디자인.md) — AsyncAPI `channels`가 가리키는 토픽의 명명 규칙
- [03-02.토픽 파이프라인](03-02.토픽%20파이프라인.md) — operations 그래프로 표현되는 파이프라인
- [03-04.한 토픽 다수 message 형태](03-04.한%20토픽%20다수%20message%20형태.md) — 한 채널에 여러 message 정의를 묶는 패턴
