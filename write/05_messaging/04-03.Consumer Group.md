...
- 브로커/파티션/복제의 아키텍처 상세는 [04-01.메시지 큐 아키텍처](./04-01.메시지%20큐%20아키텍처.md)를 참조한다.
...
- [04-01.메시지 큐 아키텍처](04-01.%EB%A9%94%EC%8B%9C%EC%A7%80%20%ED%81%90%20%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98.md) — 파티션·복제 추상 위에서 Consumer Group이 동작
- [04-04.리밸런스 프로토콜](04-04.%EB%A6%AC%EB%B0%B8%EB%9F%B0%EC%8A%A4%20%ED%94%84%EB%A1%9C%ED%86%A0%EC%BD%9C.md) — JoinGroup/SyncGroup의 더 깊은 흐름
- [04-08.Exactly-once 의미론과 Consumer Idempotency](04-08.Exactly-once%20%EC%9D%98%EB%AF%B8%EB%A1%A0%EA%B3%BC%20Consumer%20Idempotency.md) — 오프셋 커밋과 처리 사이의 비대칭
- [05-05.Inbox](05-05.Inbox.md) — Consumer 측 멱등성을 강제하는 짝 패턴
...
> - **상세**: [`spring/02-01.Avro Consumer 수신 패턴`](spring/02-01.Avro%20Consumer%20수신%20패턴.md) — JSON과 Avro consumer를 토픽별로 분리하는 이유.
>
...
>
> - 같은 메시지를 두 번 consume해도 결과가 한 번만 반영되도록 `TB_TRB_OX_002` (`(MSG_ID, CONSUMER_GROUP)` PK) 도입. 상세 의미론은 [`04-08.Exactly-once 의미론과 Consumer Idempotency`](04-08.Exactly-once%20의미론과%20Consumer%20Idempotency.md), TPS 코드 측 계획은 `message-lib/docs/inbox-idempotency-plan.md`.
