...
# Choreography-based Saga란?

---

> 코레오그래피는 중앙 조정자 없이 각 서비스가 독립적으로 반응하여 워크플로우를 완성하는 방식입니다. 

분산 환경에서 여러 서비스가 협력해야 하지만 중앙 조정자를 두면 단일 장애점이 되고 결합도가 높아집니다. 코레오그래피는 각 서비스가 자율적으로 판단하고 행동하므로 유연하고 확장 가능해집니다.
