...
> "주문 버튼 눌렀는데... 지금 어디쯤이지?" 비동기 시스템에서 클라이언트가 결과를 아는 방법은 무엇인가? [01-02.EDA 기반 요청응답 통합](./01-02.EDA%20기반%20요청응답%20통합.md)에서 다룬 4가지 브릿지 패턴 중, 가장 범용적이고 인프라 요구사항이 적은 **Event-First(202 + Polling)** 패턴을 깊이 파고든다.
...
[01-02 문서](./01-02.EDA%20기반%20요청응답%20통합.md)에서 소개한 4가지 브릿지 패턴 비교표를 다시 보자.
...
> SSE 방식이 궁금하다면 [01-02 문서의 Section 3 (Server-Sent Events)](./01-02.EDA%20기반%20요청응답%20통합.md)을 참고한다.
...
- [01-02.EDA 기반 요청응답 통합](./01-02.EDA%20기반%20요청응답%20통합.md) — 4가지 브릿지 패턴 중 이 문서가 다루는 Event-First의 상위 분류
- [05-03.Outbox](./05-03.Outbox.md) — 202 응답 이후 이벤트 발행 안정성을 보장하는 패턴
- [07-01.Kafka CQRS](./07-01.Kafka%20CQRS.md) — Polling이 조회하는 Read Model을 이벤트로 구성하는 구조
- [05-05.Inbox](./05-05.Inbox.md) — Status Consumer의 멱등 처리를 인프라 수준으로 강제하는 짝 패턴



---

← [01-02.EDA 기반 요청응답 통합](./01-02.EDA%20기반%20요청응답%20통합.md)으로 돌아가기
