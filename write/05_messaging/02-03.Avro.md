...
- [02-01.EIP Message Pattern](02-01.EIP%20Message%20Pattern.md) — Avro 스키마가 코드 외부에서 메시지 의도를 명시하는 방법
- [02-02.Schema Registry](02-02.Schema%20Registry.md) — Confluent wire format의 schema ID를 운반하는 인프라
- [02-04.EventEnvelope 적용](02-04.EventEnvelope%20%EC%A0%81%EC%9A%A9.md) — Envelope 패턴의 실전 구현
- [02-05.Avro 직렬화 예외처리 전략](02-05.Avro%20%EC%A7%81%EB%A0%AC%ED%99%94%20%EC%98%88%EC%99%B8%EC%B2%98%EB%A6%AC%20%EC%A0%84%EB%9E%B5.md) — `AvroSerializationException`을 비재시도로 분류하는 이유
- [02-06.Avro 스키마 진화 패턴](02-06.Avro%20%EC%8A%A4%ED%82%A4%EB%A7%88%20%EC%A7%84%ED%99%94%20%ED%8C%A8%ED%84%B4.md) — 필드 추가·삭제의 안전 규칙
...
> - **상세**: [`spring/02-01.Avro Consumer 수신 패턴`](spring/02-01.Avro%20Consumer%20수신%20패턴.md) — 앱 내부 Avro vs 외부 JSON 토픽 분리 전략.
