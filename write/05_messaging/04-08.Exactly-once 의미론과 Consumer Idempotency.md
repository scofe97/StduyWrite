...
- [04-03.Consumer Group](./04-03.Consumer%20Group.md) — 오프셋 추적, auto.offset.reset 정책
- [05-03.Outbox](./05-03.Outbox.md) — Producer at-least-once 짝
- [05-05.Inbox](./05-05.Inbox.md) — 본 문서의 개념 배경, 외부 API 호출이 끼는 경우의 변형
- [06-02.Kafka Streams Spring Boot](./06-02.Kafka%20Streams%20Spring%20Boot.md) — Kafka → Kafka 흐름에서의 EOS 설정
...
- [04-03.Consumer Group](04-03.Consumer%20Group.md) — 오프셋 커밋과 EOS의 비대칭
- [04-04.리밸런스 프로토콜](04-04.%EB%A6%AC%EB%B0%B8%EB%9F%B0%EC%8A%A4%20%ED%94%84%EB%A1%9C%ED%86%A0%EC%BD%9C.md) — 리밸런스 중 중복 처리의 발생 지점
- [05-03.Outbox](05-03.Outbox.md) — 발행 측 멱등성
- [05-05.Inbox](05-05.Inbox.md) — 수신 측 멱등성
- [06-02.Kafka Streams Spring Boot](06-02.Kafka%20Streams%20Spring%20Boot.md) — Streams의 EOS 모드
