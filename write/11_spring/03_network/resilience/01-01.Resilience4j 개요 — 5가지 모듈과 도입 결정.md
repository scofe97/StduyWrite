...
- `../../../08_cloud/service-mesh/11-03.Istio 레질리언스.md` <!-- 링크 끊김(2026-08): ../../../08_cloud/service-mesh/11-03.Istio 레질리언스.md --> — 같은 5가지 패턴이 *인프라 레이어* 에서 어떻게 적용되는지. *애플리케이션 vs 인프라* 의 분담 결정에 필요한 비교 축
