...
| Istio 측 회복탄력성 | 인프라 레벨 retry·timeout·circuit-breaking | `../../../08_cloud/service-mesh/11-03.Istio 레질리언스.md` <!-- 링크 끊김(2026-08): ../../../08_cloud/service-mesh/11-03.Istio 레질리언스.md --> |
