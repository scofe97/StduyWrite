...
| [02_servlet/](02_servlet/) | WAS·Servlet·멀티 스레드·쿠키/세션 (2026-05-23 1편 추가) |
| [03_mvc/](03_mvc/) | MVC 패턴·FrontController V1~V5·DispatcherServlet·PRG (2026-05-23 1편 추가) |
...
| [06_aop/](06_aop/) | 횡단 관심사·필터/인터셉터·JDK 동적 프록시·프록시 팩토리·빈 후처리기·@Aspect (2026-05-23 1편 추가) |
...
2. **`02_servlet/` → `03_mvc/`** — 웹 계층 토대. WAS·서블릿이 무엇인지부터 FrontController 진화, DispatcherServlet 까지 두 편 순차.
3. **`06_aop/`** — 프록시·AOP. 인터셉터·필터로 풀리지 않는 횡단 관심사를 만났을 때 진입.
