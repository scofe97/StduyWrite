...
WebClient([`../03_network/webflux/`](../03_network/webflux/README.md))도 기본 전송으로 Reactor Netty 를 씁니다. 즉 인바운드(WebFlux 서버)든 아웃바운드(WebClient)든, Spring 의 리액티브 HTTP 는 같은 Reactor Netty 위에서 돕니다.
...
- [Spring WebClient 학습 MOC](../03_network/webflux/README.md) — 아웃바운드도 같은 Reactor Netty 위
