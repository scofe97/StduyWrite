...
| `msa/` xx-Kafka, xx-CQRS | `04_messaging/` (주제별: 04_BrokerArchitecture·05_ConsistencyPattern·07_CQRS_EventSourcing) | |
| `msa/` 02-* (Cloud Config) / 03-* (Actuator) | `11_spring/` 또는 `06_observability/` | |
| `msa/` 04-* (OpenFeign, Eureka, Gateway) | `11_spring/` 신규 또는 `04_messaging/` | |
