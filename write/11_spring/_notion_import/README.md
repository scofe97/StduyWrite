...
| `netty/` | `[Spring Netty]` — Reactor Netty, 채널 파이프라인, NIO | 10 | 01 이관 완료(2026-05-30 → `06_reactive-net/01-01`), 나머지 9편 이관 예정 |
| `websocket/` | `[Spring WebSocket]` — STOMP, SSE | 7 | 전체 미이관 (`09_websocket/` 신설 예정) |
...
| `netty/` | `11_spring/06_reactive-net/` (신설 예정) | ⏸ 미이관 — 전체 보존 |
| `websocket/` | `11_spring/09_websocket/` (신설 예정) | ⏸ 미이관 — 전체 보존 |
