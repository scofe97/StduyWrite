...
related:
  - ../README.md
  - ../../05_data/03_persistence/jpa/04-01.스프링 트랜잭션.md
  - ../06_events/README.md
updated: 2026-05-29
---
...
트랜잭션은 도메인 결합도가 큰 주제입니다. `@Transactional` 한 줄은 영속성 계층(JPA·JDBC)과 떼어 설명하기 어렵고, 그래서 본체 문서는 [`05_data/03_persistence/jpa/`](../../05_data/03_persistence/jpa/) 에 자리잡는 편이 자연스럽습니다. 같은 내용을 `10_spring/` 에 다시 쓰면 두 곳이 어긋나는 순간 어느 쪽이 옳은지 알 수 없게 됩니다.
...
| 주제 | 위치 | 구분 |
|------|------|------|
| 추상화·동기화·AOP·전파 본체 | [`05_data/03_persistence/jpa/04-01`](../../05_data/03_persistence/jpa/04-01.%EC%8A%A4%ED%94%84%EB%A7%81%20%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98.md) | 기존(SSOT) |
| 전파 실무 시나리오 (회원+로그) | [`05_data/03_persistence/jpa/04-01b`](../../05_data/03_persistence/jpa/04-01b.%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98%20%EC%A0%84%ED%8C%8C%20%ED%99%9C%EC%9A%A9.md) | 기존 |
| 낙관적·비관적 락 (`@Version`·`@Lock`) | [`05_data/03_persistence/jpa/04-02`](../../05_data/03_persistence/jpa/04-02.%EB%82%99%EA%B4%80%EC%A0%81%20%EB%B9%84%EA%B4%80%EC%A0%81%20%EB%9D%BD.md) | 기존 |
| 격리 수준·이상현상 (DB 이론) | [`05_data/02_relational/sql-mysql/04-02`](../../05_data/02_relational/sql-mysql/04-02.%EB%8F%99%EC%8B%9C%EC%84%B1%EC%A0%9C%EC%96%B4%EC%99%80%20%EB%9D%BD.md) · [`theory/01-04`](../../05_data/01_foundation/01-04.%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98%EA%B3%BC%20%EA%B2%A9%EB%A6%AC%20%EC%88%98%EC%A4%80.md) | 기존(SSOT) |
...
1. [`05_data/03_persistence/jpa/04-01`](../../05_data/03_persistence/jpa/04-01.%EC%8A%A4%ED%94%84%EB%A7%81%20%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98.md) — 추상화·동기화·AOP 자기호출 함정·전파를 한 번에. 본 묶음의 전제입니다.
...
- [스프링 트랜잭션 (추상화·동기화·AOP·전파)](../../05_data/03_persistence/jpa/04-01.%EC%8A%A4%ED%94%84%EB%A7%81%20%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98.md) — 본 묶음이 전제하는 본체 문서
