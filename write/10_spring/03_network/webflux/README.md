...
related:
  - ../README.md
  - ../../05_data/03_persistence/querydsl/README.md
updated: 2026-05-09
---
...
위 항목 중 막히는 부분이 있다면 [`spring/`](../README.md) 직접 하위와 Reactor 공식 가이드를 먼저 보고 돌아오는 편이 빠르다. WebFlux 핸들러·라우팅 등 서버 측(인바운드) 영역은 본 묶음(아웃바운드 WebClient)에서 다루지 않고, [`01_core/04-01·04-02`](../../01_core/04-01.WebFlux%20서버%20—%20리액티브%20스택과%20어노테이션%20모델.md)에서 서블릿 MVC 의 대비로 다룬다.
