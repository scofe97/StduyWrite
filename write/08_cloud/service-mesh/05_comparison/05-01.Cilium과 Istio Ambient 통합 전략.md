...
[인터랙티브 시각화](./05-01-mesh-integration.html)에서 같은 흐름을 단계별로 따라갈 수 있다.
...
Ambient 자체 구조 디테일은 [Istio Ambient Mesh](../04_extension/03-01.Istio%20Ambient%20Mesh.md), eBPF·Hubble 디테일은 [eBPF와 Cilium](./02-01.eBPF%EC%99%80%20Cilium.md) 문서를 따로 본다. 본 장은 두 계층이 만나는 지점과 정책 겹치기 전략에 집중한다.
...
표는 출발점이고, 실제 결정은 [도입 전략과 의사결정](./04-01.%EB%8F%84%EC%9E%85%20%EC%A0%84%EB%9E%B5%EA%B3%BC%20%EC%9D%98%EC%82%AC%EA%B2%B0%EC%A0%95.md) 문서의 평가 항목(팀 역량, 운영 모델, 규모, 보안 요구)을 같이 본다.
