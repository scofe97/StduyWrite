...
Linkerd는 2021년 CNCF Graduated 프로젝트로, linkerd2-proxy는 Rust로 작성된 마이크로프록시입니다 (github.com/linkerd/linkerd2-proxy, cncf.io/projects/linkerd). Istio Ambient 모드는 1.24에서 GA로 승격됐습니다 (istio.io/blog/2024/ambient-reaches-ga).
