...
=======
Istio 현재 안정 버전은 1.30이며(직전 1.29), WasmPlugin API는 `extensions.istio.io/v1alpha1`에서 지속적으로 개선되고 있습니다. OCI 이미지 레지스트리 외에 HTTP URL로도 WASM 바이너리를 참조할 수 있어 배포 방식의 유연성이 높습니다. (istio.io)
>>>>>>> Stashed changes
