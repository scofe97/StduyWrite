...
1. **Troubleshooting(30%)** — `kubectl get/describe/logs/exec`, 노드·Pod·서비스 장애 진단([05-08](05-08.%EB%AA%A8%EB%8B%88%ED%84%B0%EB%A7%81%EA%B3%BC%20%ED%8A%B8%EB%9F%AC%EB%B8%94%EC%8A%88%ED%8C%85.md))
2. **Cluster Architecture(25%)** — kubeadm 업그레이드·etcd 백업([05-01](05-01.%ED%81%B4%EB%9F%AC%EC%8A%A4%ED%84%B0%20%EC%97%85%EA%B7%B8%EB%A0%88%EC%9D%B4%EB%93%9C%EC%99%80%20ETCD%20%EB%B0%B1%EC%97%85%C2%B7%EB%B3%B5%EA%B5%AC.md)), RBAC([05-09](05-09.RBAC%EA%B3%BC%20%EB%B3%B4%EC%95%88.md))
3. **Services & Networking(20%)** — Service·Ingress·NetworkPolicy([02_networking](../02_networking/README.md))
4. **Workloads & Scheduling(15%)** — Deployment·rollout, 스케줄링([05-05](05-05.%EC%8A%A4%EC%BC%80%EC%A4%84%EB%A7%81%EA%B3%BC%20%EB%85%B8%EB%93%9C%20%EC%84%A0%ED%83%9D.md))
5. **Storage(10%)** — PVC·StorageClass·StatefulSet([01-03](../01_foundation/01-03.%EC%8A%A4%ED%86%A0%EB%A6%AC%EC%A7%80%EC%99%80%20%EC%83%81%ED%83%9C.md))

여기에 JSONPath([05-03](05-03.JSONPath%EC%99%80%20kubectl%20%EA%B3%A0%EA%B8%89%20%EC%A1%B0%ED%9A%8C.md))·`kubectl explain`·`drain`·`rollout undo` 같은 반복 명령이 붙습니다.
