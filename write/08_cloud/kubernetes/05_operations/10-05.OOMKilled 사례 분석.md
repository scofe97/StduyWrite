...
2. 컨테이너 `limits.memory` 가 cgroup `memory.max` 로 내려간다는 점을 압니다([10-03](10-03.%EC%9E%90%EC%9B%90%20%EA%B4%80%EB%A6%AC.md)).
...
- [`./10-03.자원 관리.md`](10-03.%EC%9E%90%EC%9B%90%20%EA%B4%80%EB%A6%AC.md) — requests/limits 와 QoS 클래스의 이론
- [`./10-04.오토스케일링.md`](10-04.%EC%98%A4%ED%86%A0%EC%8A%A4%EC%BC%80%EC%9D%BC%EB%A7%81.md) — HPA 가 Requests 를 분모로 어떻게 쓰는가
