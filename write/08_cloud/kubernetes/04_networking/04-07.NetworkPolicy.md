...
운영 namespace에 기본 거부를 도입할 때는 먼저 실제 의존성을 출발지, 목적지, protocol, port로 목록화합니다. 그런 다음 양방향 default-deny를 배치하고 DNS와 관측·제어 경로를 포함한 필수 egress, 애플리케이션별 ingress를 작은 정책으로 추가합니다. 합집합 모델에서는 정책 하나가 하나의 허용 책임만 갖게 해야 영향 범위를 검토하고 나중에 안전하게 회수하기 쉽습니다.



## 관련 문서

> 네트워크의 기반, Service 주소 변환, DNS 예외를 연결합니다.
