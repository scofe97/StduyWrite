...
[인터랙티브 시각화](04-02-pod-network.html)에서 같은 흐름을 노드 토폴로지 위에서 단계별로 따라갈 수 있습니다. 본 장은 Kubernetes 추상이 닿는 깊이까지만 다룹니다. 한 단계 더 내려가 커널 자료구조·netfilter hook·conntrack까지 보고 싶으면 [N&K 02-01. 커널이 패킷을 다루는 법](../../book/networking-and-kubernetes/02-01.%EC%BB%A4%EB%84%90%EC%9D%B4%20%ED%8C%A8%ED%82%B7%EC%9D%84%20%EB%8B%A4%EB%A3%A8%EB%8A%94%20%EB%B2%95%20%E2%80%94%20%EC%86%8C%EC%BC%93%C2%B7Netfilter%C2%B7Conntrack%C2%B7%EB%9D%BC%EC%9A%B0%ED%8C%85.md)로 넘어가면 됩니다.
...
- `서비스 메시 기초` <!-- 링크 끊김(2026-08): ../../service-mesh/01_foundation/01-01.서비스 메시 기초.md --> — 본 장 위에서 L7 정책이 추가될 때 어디가 바뀌는지
