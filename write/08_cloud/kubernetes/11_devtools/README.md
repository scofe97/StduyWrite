...
## 문서 목록
> 공식 concepts에는 없는 비공식 주제입니다 — K8s 위에 올려 쓰는 CI/CD·GitOps·레지스트리 도구를 모았습니다. 파일 번호(`11-MM`)가 읽기 순서입니다. 각 본문 끝에는 `## N. 점검 질문` 절이 있어, 개념 설명과 심화 Q&A를 한 문서에서 이어 읽습니다(일부 입문 편 제외).
