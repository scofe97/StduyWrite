...
related:
  - ./deepdive/06-02.MySQL Operator 점검.md
...
- [MySQL Operator 점검](./deepdive/06-02.MySQL%20Operator%20점검.md) — 본 장의 점검 편, GCP K8s 클러스터 기준
- [Operator 패턴](./06-01.Operator%20패턴.md) — 이전 절, CRD와 컨트롤러 연동 원리
