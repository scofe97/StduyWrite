...
[인터랙티브 시각화](02-02-pod-network.html)에서 같은 흐름을 노드 토폴로지 위에서 단계별로 따라갈 수 있다. 본 장은 Kubernetes 추상이 닿는 깊이까지만 다룬다. 한 단계 더 내려가 커널 자료구조·netfilter hook·conntrack까지 보고 싶으면 [02_os/networking/01-01.네트워킹 기초](../../../02_os/networking/01-01.%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%82%B9%20%EA%B8%B0%EC%B4%88.md)로 넘어간다.
