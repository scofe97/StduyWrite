...
related:
  - ./deepdive/06-06.Redpanda Operator 점검.md
...
- [Redpanda Operator 점검](./deepdive/06-06.Redpanda%20Operator%20점검.md) — 본 장의 점검 편
- [Kafka Operator](./06-05.Kafka%20Operator.md) — 이전 절, Strimzi 기반 Kafka 운영
- [Jenkins on K8s](./07-01.Jenkins%20on%20K8s.md) — 다음 장, CI/CD 자동화
