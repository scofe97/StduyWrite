...
2. [Helm 기초](../03_platform/03-01.Helm%20%EA%B8%B0%EC%B4%88.md)의 Chart·Release 를 이해합니다.
3. [ArgoCD와 GitOps](04-03.ArgoCD%EC%99%80%20GitOps.md)의 "Git = 단일 진실 공급원" 개념을 압니다.
...
- [Helm 기초](../03_platform/03-01.Helm%20%EA%B8%B0%EC%B4%88.md) — 차트 패키징과 릴리스 관리
- [Harbor 점검](04-04.Harbor%20%EC%A0%90%EA%B2%80.md) — 프로젝트·로봇 계정·OCI chart 실전 점검
- [ArgoCD와 GitOps](04-03.ArgoCD%EC%99%80%20GitOps.md) — Git 과 Harbor artifact 를 연결
