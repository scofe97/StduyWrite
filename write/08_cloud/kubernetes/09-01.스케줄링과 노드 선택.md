...
related:
  - ./deepdive/09-01.스케줄링과 노드 선택 점검.md
  - ./08-04.CKA 대비와 문제 풀이 전략.md
...
다음 장 [토폴로지 분산과 중단 정책](./09-02.토폴로지%20분산과%20중단%20정책.md)에서 Topology Spread Constraints, PodDisruptionBudget, PriorityClass·Preemption, Eviction 흐름을 한 번에 정리한다.
...
- [스케줄링과 노드 선택 점검](./deepdive/09-01.%EC%8A%A4%EC%BC%80%EC%A4%84%EB%A7%81%EA%B3%BC%20%EB%85%B8%EB%93%9C%20%EC%84%A0%ED%83%9D%20점검.md) — 본 장의 점검 편
- [토폴로지 분산과 중단 정책](./09-02.토폴로지%20분산과%20중단%20정책.md) — 다음 장, Topology Spread/PDB/PriorityClass/Eviction
- [배치 워크로드](./09-03.배치%20워크로드.md) — Job·CronJob·DaemonSet·InitContainer·Sidecar
