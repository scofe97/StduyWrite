...
source:
  ...
  - https://helm.sh/docs/
related:
  - 03-01.Helm%20%EA%B8%B0%EC%B4%88%20%EC%A0%90%EA%B2%80.md
  - ../02_networking/02-06.Ingress%EC%99%80%20Gateway%20API.md
...
- [Helm 기초 점검](03-01.Helm%20%EA%B8%B0%EC%B4%88%20%EC%A0%90%EA%B2%80.md) — 본 장의 점검 편, bitnami/nginx로 install→upgrade→rollback 사이클
- [Ingress와 Gateway API](../02_networking/02-06.Ingress%EC%99%80%20Gateway%20API.md) — 이전 장, 외부 트래픽 진입 계층
- [Helm 고급](03-02.Helm%20%EA%B3%A0%EA%B8%89.md) — 다음 절, 차트 개발과 템플릿 설계
