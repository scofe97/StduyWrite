...
| 장 | 문서 | 다루는 핵심 |
|----|------|-----------|
| 03-01 | [Helm 기초](03-01.Helm%20%EA%B8%B0%EC%B4%88.md) | 왜 매니페스트 대신 Helm 인가 — Chart·Release·values |
| 03-02 | [Helm 고급](03-02.Helm%20%EA%B3%A0%EA%B8%89.md) | 재사용 가능한 차트 설계 — 템플릿 함수·의존성·hooks |
| 03-03 | [Kustomize](03-03.Kustomize.md) | 템플릿 없이 base/overlay 로 환경 차이 관리 |
| 03-04 | [K8s 환경변수와 Spring 설정 주입](03-04.K8s%20%ED%99%98%EA%B2%BD%EB%B3%80%EC%88%98%EC%99%80%20Spring%20%EC%84%A4%EC%A0%95%20%EC%A3%BC%EC%9E%85.md) | ConfigMap 환경변수가 Spring YAML 에 적용되는 경로 |

### Operator 패턴과 DB·미들웨어 (Ch06)

| 장 | 문서 | 다루는 핵심 |
|----|------|-----------|
| 03-05 | [Operator 패턴](03-05.Operator%20%ED%8C%A8%ED%84%B4.md) | CRD + Controller 연동, reconcile 루프 |
| 03-06 | [MySQL Operator](03-06.MySQL%20Operator.md) | MySQL HA 자동화 |
| 03-07 | [PostgreSQL Operator](03-07.PostgreSQL%20Operator.md) | CloudNativePG 복제·백업 전략 |
| 03-08 | [Redis Operator](03-08.Redis%20Operator.md) | Cluster vs Sentinel 선택 기준 |
| 03-09 | [Kafka Operator](03-09.Kafka%20Operator.md) | Strimzi 로 Kafka 선언적 관리 |
| 03-10 | [Redpanda Operator](03-10.Redpanda%20Operator.md) | Strimzi 와 Redpanda Operator 비교 |
