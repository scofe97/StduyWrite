...
- [Helm 고급 점검](./deepdive/05-02.Helm%20%EA%B3%A0%EA%B8%89%20점검.md) — 본 장의 점검 편, 차트 생성·템플릿·Hook 실습
- [Helm 기초](./05-01.Helm%20기초.md) — 이전 장, install·upgrade·rollback 워크플로우
- [Operator 패턴](./06-01.Operator%20패턴.md) — 다음 장, CRD + Controller로 운영 자동화
