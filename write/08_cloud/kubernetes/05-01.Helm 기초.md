...
- [Helm 기초 점검](./deepdive/05-01.Helm%20%EA%B8%B0%EC%B4%88%20점검.md) — 본 장의 점검 편, bitnami/nginx로 install→upgrade→rollback 사이클
- [Ingress와 Gateway API](./04-06.Ingress와%20Gateway%20API.md) — 이전 장, 외부 트래픽 진입 계층
- [Helm 고급](./05-02.Helm%20고급.md) — 다음 절, 차트 개발과 템플릿 설계
