...
d = D(W, H, "LEARNING COREDNS · 06-01",
      ...
      "6장 전반부의 절 여덟을 읽는 순서로 이은 지도. 1~4절이 쿠버네티스의 구조와 네트워킹이고, "
      "5~8절이 그 위에 얹힌 DNS 명세다.",
...
cards = [
    ...
    ("§8", "파드 A 레코드 · 현행 명세에서 빠짐", "존재 확인을 안 해서 신원이 샌다"),
]
...
d.t(20, 632, "1~4절 · 쿠버네티스의 구조 · 5~8절 · 이름이 나오는 규칙", 13, MUTED, KR, "start")
d.t(20, 656, "8절 · 명세가 걷어낸 파드 레코드", 13, MUTED, KR, "start")
