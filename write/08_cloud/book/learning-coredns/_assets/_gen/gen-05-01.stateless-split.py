...
d = D(W, H, "LEARNING COREDNS · 05-01 §4",
      ...
      "위 존의 CoreDNS 는 자기 상태를 갖지 않아 어느 인스턴스가 답해도 결과가 같다. "
      "영속 상태는 전부 아래 존의 etcd 에 있고, 쿼럼만 살아 있으면 하나를 잃어도 계속 돈다.",
...
d.t(20, 584, "위 존의 인스턴스는 죽어도 잃을 정보가 없어서 그냥 다시 띄우면 된다", 13, MUTED, KR, "start")
