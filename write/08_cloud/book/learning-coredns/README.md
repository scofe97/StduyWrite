...
- 원문(챕터 PDF)이 1차 자료입니다. 사실·수치·API 이름은 추출한 원문에서만 가져오고, 책 밖 보강은 공식 문서 링크를 각주로 달고, 해당 절 본문에 "노트의 읽기" 인용 블록이나 출처 표시 문장으로 녹입니다. 2026-09-26 에 1~9장 전체에서 `## 심화 학습` 절을 본문으로 흡수했습니다.
