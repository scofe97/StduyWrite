...
실제 트래픽 가중치·헤더 기반 라우팅·자동 승격은 Flagger·Argo Rollouts가 service mesh(Istio·Linkerd)나 ingress의 트래픽 분할 기능을 얹어야 됩니다. 그래서 이 장은 "advanced, production-ready 시나리오에는 이 확장들을 보라"고 권합니다.
