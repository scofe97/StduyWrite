...
d.t(438, 232, "설정", 9, INFO, KR, "middle", 600)
d.t(812, 186, "url 이 가리키는 곳", 9, ACC, KR, "middle", 600)
...
d.t(68, BY + 72, "적용한 뒤 httpbin 을 부르면 응답 헤더에 hello: world! 가 붙어 온다", 10.5, SOFT, KR, "start")
