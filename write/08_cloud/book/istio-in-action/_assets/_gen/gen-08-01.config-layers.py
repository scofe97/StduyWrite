...
d.t(28, 420, "백엔드 주소 · sampling · customTags 가 전부 이 블록 하나에 들어간다", 11, SOFT, KR, "start")
d.t(28, 444, "설치 시점의 IstioOperator 도 결국 같은 MeshConfig 를 쓰므로 자리는 늘지 않는다", 11, SOFT, KR, "start")
