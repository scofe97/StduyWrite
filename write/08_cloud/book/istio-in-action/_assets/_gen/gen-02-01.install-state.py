...
# 라벨이 한 줄이면 폭 132 라 상자 사이 간격(476~568)을 넘어 왼쪽 상자를 파고들었다.
# 두 줄로 나누면 각 줄이 66 이라 간격 안에 든다.
d.t(520, 182, "함께 깔지만", 11, MUTED, KR, "middle")
d.t(520, 196, "필수는 아니다", 11, MUTED, KR, "middle")
d.path("M 476 342 L 532 342 L 532 346 L 568 346", ACC, 1.5, m="acc")
d.t(520, 322, "앱 + 주입이", 11, ACC, KR, "middle", 600)
d.t(520, 336, "있어야 생긴다", 11, ACC, KR, "middle", 600)
