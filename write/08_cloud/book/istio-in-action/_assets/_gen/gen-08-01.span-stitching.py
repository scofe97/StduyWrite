...
d.lanes([("클라이언트", "curl"),
         ...
         ("catalog", "app + istio-proxy")], y0=104, lane_w=216)
d.rails(524)
...
d.line(544, 418, 544, 512, MUTED, 1.0)
d.line(544, 418, 560, 418, MUTED, 1.0)
d.line(544, 512, 560, 512, MUTED, 1.0)
d.t(536, 462, "택일", 11, SOFT, KR, "end", 600)
