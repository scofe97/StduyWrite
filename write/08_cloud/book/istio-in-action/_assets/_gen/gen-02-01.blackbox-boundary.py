...
AX, AY, AR = 664, 316, 176   # 애플리케이션이 아는 것
...
d.t(240, 148, "프록시가 보는 것", 13, INK, KR, "middle", 600)
d.t(240, 168, "network observed", 9, MUTED, MONO, "middle")
d.t(880, 148, "애플리케이션이 아는 것", 13, INK, KR, "middle", 600)
d.t(880, 168, "self-reported", 9, MUTED, MONO, "middle")

d.t(316, 292, "요청 수 · 지연", 11, INK, KR, "middle")
d.t(316, 314, "실패 · 재시도", 11, INK, KR, "middle")
d.t(316, 336, "서킷 브레이킹 발생", 11, INK, KR, "middle")
d.t(316, 366, "코드 변경 없이 나온다", 9, SOFT, KR, "middle")

d.t(552, 292, "서비스 사이의", 10, MUTED, KR, "middle")
d.t(552, 312, "스팬과 전파", 10, MUTED, KR, "middle")

d.t(766, 286, "요청 하나가", 11, ACC, KR, "middle")
d.t(766, 308, "안에서 만든 인과", 11, ACC, KR, "middle", 600)
d.t(766, 336, "들어온 헤더를 나가는", 9, MUTED, KR, "middle")
d.t(766, 354, "요청에 넣는 일", 9, MUTED, KR, "middle")
d.o.append(f'<circle cx="{766}" cy="{258}" r="5" fill="{ACC}"/>')

d.t(32, 552, "계측을 아무리 해도 그것은 자기 보고다 — 둘이 어긋나면 프록시 쪽이 실제로 오간 요청이다", 11, SOFT, KR, "start")
d.t(32, 576, "Istio 는 서비스 안에서 무슨 일이 있었는지 알 수 없어 인과를 짝지을 수 없다", 11, MUTED, KR, "start")
