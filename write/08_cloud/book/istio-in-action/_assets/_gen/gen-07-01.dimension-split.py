...
# 텍스트 블록(x 540~852)을 피해 오른쪽으로 내린다. x=808 로 두면 코드 두 줄을 관통해
# 화살표가 보이지 않았다. +1 상자는 672~940, 끝 타원은 596~960 이라 908 이 둘 다에 걸린다.
d.path("M 908 408 L 908 566", MUTED, 1.2, m="ar")
