...
d = D(W, H, "ISTIO IN ACTION · 01-01 §4",
      ...
      "색이 붙은 줄이 옮겨서 얻는 것이고, 점선으로 비운 위 칸이 애플리케이션에서 빠져나가는 자리다.",
...
# 옮겨 가는 방향 — x 는 cell 과 같은 공식에서 뽑는다.
# 옛 배치의 상수(232 + j*244)가 남아 네 화살표가 다 어긋나 있었고 넷째는 1054 로
# 캔버스(폭 1000) 를 벗어나 보이지도 않았다. cell 은 x = 188 + j * 196 이다.
for j in range(4):
    x = 188 + j * 196 + BW / 2
