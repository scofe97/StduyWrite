...
FY = 396
d.box(28, FY, 940, 92, PAPER2, RULE, 1.0, 6)
d.t(44, FY + 26, "쿠버네티스에서 그대로 옮겨 온 대응", 11, ACC, KR, "start", 600)
d.t(44, FY + 50, "Deployment  ->  WorkloadGroup            복제본을 어떻게 만들지의 설정을 담는다", 11, INK, MONO, "start")
d.t(44, FY + 72, "Pod         ->  WorkloadEntry            고유한 것이 없어서 버리고 갈아 끼울 수 있다", 11, INK, MONO, "start")

d.t(28, 524, "자동 등록 — 워크로드가 토큰으로 그룹 멤버임을 인증하면 컨트롤 플레인이 WorkloadEntry 를 만든다", 11, SOFT, KR, "start")
d.t(28, 548, "자동 정리 — VM 을 지우면 그 WorkloadEntry 도 사라진다. 만들어지는 것만큼 치워지는 것도 중요하다", 11, MUTED, KR, "start")
