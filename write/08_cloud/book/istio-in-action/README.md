...
learning:
  ...
  blocked_count:
  next_lesson: "부록 A·B·E 완료. 남은 것은 C(SPIFFE)와 D(포트·디버그 엔드포인트 지도) 둘. C 는 9 장이 위임처로 지목해 둔 자리이고 PKI·TLS 핸드셰이크는 99_ETC/security 와 Container Security 11 장으로 넘긴다"
updated: 2026-09-02
---
