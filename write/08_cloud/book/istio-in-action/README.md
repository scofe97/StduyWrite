...
learning:
  ...
  blocked_count:
  next_lesson: "부록 A·B·C·E 완료. 남은 것은 D 하나 — 에이전트와 Pilot 이 여는 포트 열일곱과 디버그 엔드포인트 지도다. 책 전체에 흩어져 있던 15000·15020·15012 같은 번호를 한자리에 모으는 치트시트 성격이다"
updated: 2026-09-02
---
