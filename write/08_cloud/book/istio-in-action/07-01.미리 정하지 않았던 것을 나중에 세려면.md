...
2. 모니터링과 관측 가능성은 어떤 관계이며, 각각 어떤 실패를 전제합니까?
3. 필요한 프록시 통계가 보이지 않을 때 무엇을 의심하고, 어떤 손잡이로 되살립니까? 저자가 권하는 자리는 어디입니까?
4. 메트릭에 차원을 더하거나 새 메트릭을 만들 때 고쳐야 하는 자리는 어디이며, 각각 무엇을 정합니까?
