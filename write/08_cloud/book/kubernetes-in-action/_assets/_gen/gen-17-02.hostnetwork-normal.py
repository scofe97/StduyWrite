...
ddx.node(d, 470, 300, "커널 규칙", "DNAT — 목적지를 바꾼다", 240, 76, ACC)
d.path("M 302 300 L 348 300", MUTED, 1.5, m="ar")
d.chip(325, 272, "dst 노드 IP", SOFT, 9)

d.box(660, 236, 440, 152, PAPER2, OK, 1.0, 8)
d.t(880, 262, "파드 전용 netns", 11, OK, KR)
ddx.node(d, 880, 320, "컨테이너", "10.244.1.7:8080", 300, 62, OK)
d.path("M 592 300 L 652 300", OK, 1.5, m="ok")
d.chip(622, 272, "dst 파드 IP", ACC, 9)
d.t(622, 348, "veth", 10, SOFT, MONO)
