...
d.path("M 292 276 L 424 224", OK, 1.5, m="ok")
...
d.path("M 292 324 L 424 376", ACC, 1.5, m="acc")
...
d.path("M 754 224 L 848 244", OK, 1.4, m="ok")
d.path("M 754 376 L 848 356", ACC, 1.4, m="acc")
