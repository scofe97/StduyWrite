...
ddx.band(d, 104, 532, "web1 이 바꾼 뒤 새로 띄워도 이미지 원본에서 시작한다 — 이미지는 불변이다")
...
d.t(36, 484, "web1 의 수정은 web1 의 쓰기 레이어에만 있다 — 공유 이미지 레이어는 손대지 않는다.",
     12, MUTED, KR, "start")
d.legend(548, [("건드린 쪽 — 사본이 생긴다", ACC), ("안 건드린 쪽", OK), ("새로 뜬 쪽", INFO)])
