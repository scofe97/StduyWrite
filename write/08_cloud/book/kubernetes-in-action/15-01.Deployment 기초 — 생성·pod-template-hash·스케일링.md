...
Deployment의 개념 모델·컨트롤러·RollingUpdate는 [핵심 워크로드 통합 개념본](../../kubernetes/01_foundation/01-02.%ED%95%B5%EC%8B%AC%20%EC%9B%8C%ED%81%AC%EB%A1%9C%EB%93%9C.md)이 크게 다룹니다. 이 편은 책의 실습(Kiada·pod-template-hash 실측·kubectl) 관점에서 차이분을 정리합니다.
...
- [핵심 워크로드](../../kubernetes/01_foundation/01-02.%ED%95%B5%EC%8B%AC%20%EC%9B%8C%ED%81%AC%EB%A1%9C%EB%93%9C.md) — Deployment·ReplicaSet·컨트롤러 통합 개념본
