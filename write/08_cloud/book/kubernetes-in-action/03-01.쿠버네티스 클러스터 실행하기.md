...
> 여기서는 이 책이 다루는 세 도구(Docker Desktop·Minikube·kind)의 서술만 짚었습니다. 로컬 클러스터 셋업의 세부 아키텍처(desired state·reconcile loop, control plane/worker 역할 분리, kubeconfig·context, 디버깅 루틴)는 다루지 않습니다.
