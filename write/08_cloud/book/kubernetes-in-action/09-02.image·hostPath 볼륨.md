...
[^image-volume]: Kubernetes 공식 문서 [image volumes](https://kubernetes.io/docs/tasks/configure-pod-container/image-volumes/): "FEATURE STATE: `Kubernetes v1.36 [stable]` (enabled by default)".

    볼륨 소스의 정의는 [Volumes / image](https://kubernetes.io/docs/concepts/storage/volumes/#image) 에 있습니다: "An `image` volume source represents an OCI object (a container image or artifact) which is available on the kubelet's host machine."
