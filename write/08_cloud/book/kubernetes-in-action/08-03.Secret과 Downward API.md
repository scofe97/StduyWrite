...
> Secret의 Base64 저장·주입 동작과 Downward API의 필드 주입을 `kind-k8s-lab` 클러스터(v1.35)에서 확인했습니다. 전체 매니페스트와 재현 명령은 실습 저장소 [k8s_in_action/08-configuring-apps/secret-downward](../../../../../k8s_in_action/08-configuring-apps/secret-downward/README.md)에 있습니다.
