...
- [배치 워크로드](../../kubernetes/05_operations/05-07.%EB%B0%B0%EC%B9%98%20%EC%9B%8C%ED%81%AC%EB%A1%9C%EB%93%9C.md) — CronJob `concurrencyPolicy`·`startingDeadlineSeconds`·Init/Sidecar 개념본(개념 위임)
