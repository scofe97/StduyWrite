...
⚠️ 우선순위 판정은 한 HTTPRoute 안이 아니라 **그 Gateway에 붙은 모든 Route를 통틀어** 이뤄집니다("Across all rules specified on applicable Routes"). 여러 팀이 Route를 각자 만들어 붙이면, 다른 팀 Route의 더 구체적인 rule이 내 rule을 이길 수 있습니다.
