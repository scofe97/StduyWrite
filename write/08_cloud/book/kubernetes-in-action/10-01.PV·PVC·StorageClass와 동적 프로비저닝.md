...
NFS는 파일 스토리지라 여러 노드가 동시에 마운트할 수 있습니다. 그래서 §6에서 본 RWX를 지원하고, volumeBindingMode를 WaitForFirstConsumer로 미룰 이유도 없습니다 — 파드가 어느 노드에 가든 접근할 수 있으니 Immediate가 자연스럽습니다.
