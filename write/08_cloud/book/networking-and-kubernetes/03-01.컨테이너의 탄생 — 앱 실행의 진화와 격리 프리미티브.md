...
<!-- no-diagram: 서브시스템 목록이라 격자 축이 없고, cgroup 과 namespace 의 분업은 §4 도식이 함께 다룹니다 -->
...
> namespace는 시야를 정합니다. 6종이 각각 다른 자원을 격리하며, 그중 User namespace 가 "컨테이너 안에서는 root 인데 밖에서는 아닌" 구조를 만듭니다.
