...
CARDS = [("§1",   "실패",      "하나가 다 하던 NCP 의 붕괴", INFO,
          ["· 네트워크가 다양해짐", "· 한 프로토콜이 병목", "· 신뢰성과 전달을 쪼갬"]),
         ("§2",   "개념 틀",   "책임을 나누는 언어",   INFO,
          ["· OSI 7계층", "· 캡슐화 — 감싸기 · 벗기기", "· 각 계층은 자기 헤더만"]),
         ("§3",   "표준 경쟁", "OSI 패배 · 용어는 존속",   BAD,
          ["· TCP/IP 가 실무 표준", "· OSI 는 교육 도구로", "· 가장 자주 오해되는 자리"]),
         ("§4·5", "남은 것",   "4계층 모델 · 실습으로 연결", OK,
          ["· OSI 7 ↔ TCP/IP 4", "· 계층 이름으로 부르기", "· 다음 편들의 토대"])]
...
# 하단 해설(붉은 칸의 뜻)은 도식 앞 본문 문단이 그대로 말한다 — 뺐다
