# 02-03.chapter-overview — 네 단계 흐름 (구조 → 규칙 → 실전 → 대안)
...
NODES = [("구성과 실행", "훅 · 우선순위", "같은 이름 다른 체인", None),
         ("매치·타깃", "조건은 안 바꾼다", "바꾸는 건 -j 하나", None),
         ("확률 분배", "0.333 · 0.5 · 무조건", "mark 0x4000 · DNAT", ACC),
         ("IPVS·eBPF", "해시 표 · 커널 맵", "리스트 순회의 한계", INFO)]
EDGE = ["그 안에", "쌓으면", "한계에서"]
...
print("ok 02-03.chapter-overview")
