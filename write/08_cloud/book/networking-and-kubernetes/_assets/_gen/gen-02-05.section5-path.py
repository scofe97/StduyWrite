# 02-05.section5-path — 패킷 하나가 §5 의 부품들을 지나는 전체 경로
...
W, H = 1000, 736   # 범례 구분선 아래 56px — 계약 §검증 '범례 아래 여유 30px'
...
d.save("02-05.section5-path.svg")
