# 02-06.ladder-narrowing — 사다리를 밟을 때마다 용의자 범위가 줄어든다
...
#           반복되는 Stage framework with semantic slots. 02-04.triage-ladder 와 같은 근거이며
...
# 2026-09-18 통로 26 → 48px. 폭을 넓히면 본문에서 글자가 그만큼 작아지므로(스타일 계약 §캔버스 폭)
#            카드 폭을 164 → 152 로 줄여 통로를 얻는다. 좌우 여백 24px 씩.
BW, GAP, X0 = 152, 48, 24
CY = 268
...
d.save("02-06.ladder-narrowing.svg")
