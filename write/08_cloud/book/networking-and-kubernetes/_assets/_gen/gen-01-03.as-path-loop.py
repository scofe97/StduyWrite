...
# 고리 세 변 — 목록은 변 위의 칩으로
d.path(f"M {A200[0]+70} {A200[1]+44} L {A400[0]-78} {A400[1]-52}", MUTED, 1.6, m="ar")
d.chip(672, 330, "[200]", INFO, 12)
d.path(f"M {A400[0]-BW//2-8} {A400[1]} L {A500[0]+BW//2+10} {A500[1]}", MUTED, 1.6, m="ar")
d.chip(500, 404, "[400, 200]", INFO, 12)
d.path(f"M {A500[0]+78} {A500[1]-52} L {A200[0]-70} {A200[1]+44}", BAD, 1.8, m="bad")
d.chip(330, 330, "[500, 400, 200]", BAD, 12)
