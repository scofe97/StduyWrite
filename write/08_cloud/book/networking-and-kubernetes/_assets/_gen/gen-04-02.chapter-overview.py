...
ddx.band(d, 104, 496, "얇은 명세 · 갈리는 구현체 · 관문은 정책 지원")
ddx.stage_chain(d, 316, ["§1 명세", "§2 구현체", "§3 실습", "§4 kube-proxy"], [("네 연산", "JSON stdin·stdout", "바이너리 하나", None),
   ("구현체", "4대 비교", "정책 지원이 관문", None),
   ("실습", "KIND · Cilium", "기본 CNI 끄기", None),
   ("번역기", "ClusterIP → Pod", "iptables 가 기본값", ACC)], ["구현이", "띄워 보면", "트래픽은"], sizes=(14, 12, 12))
