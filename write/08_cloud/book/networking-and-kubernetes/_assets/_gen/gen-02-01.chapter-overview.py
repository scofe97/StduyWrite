...
d = D(W, H, "02-01 · CHAPTER MAP",
      "커널이 패킷을 다루는 법 개념 지도 — 이 편은 점선 안을 다룬다",
      "위는 유저 공간에서 부르는 쪽, 아래는 물리 네트워크. 그 사이 커널이 맡는 네 갈래가 이 편이다. 패킷이 지나는 시간순이 아니라 다루는 주제의 배치다 — 시간순은 6절 끝의 관통 도식이 맡는다.",
      lead="주제 배치도 · 패킷이 지나는 시간순이 아니다")

BX, BW, BH = 180, 640, 64
RING = (156, 232, 688, 468)                                    # 링 라벨 마스크가 첫 행에 닿지 않게 위로
APP_CY, NIC_CY = 180, 756
STEPS = [(296, "소켓 · fd", "앱과 커널의 분업", "§1 · §2"),   # stride 112 — 통로 48px
         (408, "veth · 브리지", "네임스페이스 배선", "§3"),
