...
ddx.band(d, 104, 484, "갈래 둘 · 멤버 지목 또는 전체 호출")
...
d.t(249, 314, ddx.fit("이름 위임", 12, 74, "corridor"), 12, MUTED, KR)

# 3단 — 두 갈래
box(760, 240, 380, 96, "Pod 별 레코드", "postgres-0.postgres.default.svc…", "10.244.1.3 · 멤버 지목", OK)
box(760, 420, 380, 96, "서비스 레코드", "postgres.default.svc.cluster.local", "10.105.214.153 · 전체 호출", INFO)
d.path("M 514 306 L 552 306 L 552 240 L 566 240", OK, 1.5, m="ok")
d.path("M 514 354 L 552 354 L 552 420 L 566 420", INFO, 1.5, m="info")

d.legend(500, [("멤버를 지목하는 이름", OK), ("전체를 부르는 이름", INFO), ("이름을 만드는 자리 · 필수", ACC)])
