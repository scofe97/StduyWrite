...
LX = ddx.lanes(d, [("API 서버", "상태 보관"), ("스케줄러", "노드 이름 기록"),
                   ("kubelet", "실제 생성"), ("CNI", "주소와 경로")], y0=104, lane_w=196)
API, SCH, KUB, CNI = (int(LX[k]) for k in ("API 서버", "스케줄러", "kubelet", "CNI"))
SEGS = [(164, 292, "1 · 스케줄러 · 노드 이름만 기록", False),
        (308, 396, "2 · Kubelet · 자기 몫 발견", False),
        (412, 556, "3 · 생성 · CRI 는 컨테이너 · CNI 는 네트워크", True)]
Y_END = 576
...
d.legend(Y_END + 24, [("API 흐름", INFO), ("실제로 만드는 구간", ACC)])
