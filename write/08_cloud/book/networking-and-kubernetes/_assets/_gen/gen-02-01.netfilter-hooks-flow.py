...
CX = [96 + BW // 2 + i * (BW + GAP) for i in range(6)]          # 166 314 462 610 758 906
...
d.t(36, 156, "장면 — 클러스터 밖 클라이언트가 노드의 NodePort 30080 으로 보낸다. DNAT 뒤 목적지가 Pod IP 라 이 노드는 중계한다", 12, SOFT, KR, "start")
BTOP = 186
