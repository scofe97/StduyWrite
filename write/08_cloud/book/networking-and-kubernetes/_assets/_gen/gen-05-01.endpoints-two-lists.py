...
ddx.band(d, 104, 440, "서비스 = 조건 · 이 객체 = 지금 받는 주소")
...
d.t(52, 482, "라벨 제거 실험 · kubectl label pod … app=nope --overwrite", 12, ACC, KR, "start", 600)
d.t(52, 508, "endpoints 컨트롤러 · 목록에서 그 주소 제거", 12, MUTED, KR, "start")
d.t(520, 508, "ReplicaSet 컨트롤러 · 부족분만큼 새 Pod 생성", 12, MUTED, KR, "start")
d.legend(564, [("트래픽이 가는 목록", OK), ("빠지는 목록", BAD), ("떼어 내는 손잡이", ACC)])
