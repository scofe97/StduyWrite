# 02-05.build-steps — 명령 하나가 배선을 어떻게 바꾸는가
...
d.t(LX, 194, "빈 네임스페이스 둘 · 장치 없음", 12, MUTED, KR, "start")
...
d.t(LX, 302, "관 하나에 두 끝 · 둘 다 기본 netns", 12, MUTED, KR, "start")
...
d.t(LX, 478, "안쪽 끝만 옮김 · 여기서 경계를 넘음", 12, ACC, KR, "start")
d.path(f"M {SX+SW+16} 464 L {LX-12} 464", ACC, 1.2, dash="4 4")

# 만드는 명령과 옮기는 명령이 갈린다는 요점은 본문 §2 가 맡는다
d.legend(648, [("만든 직후 — 전부 한자리", INFO), ("옮긴 뒤 — 목록이 갈라진다", ACC)])
d.save("02-05.build-steps.svg")
