...
| 최근 검증 결과 | 16장 — 전항 통과, 원문 정오·버전 차이 6건 병기(ReplicaSet apiVersion·FQDN 순서·StorageClass 애노테이션 2종·PV 회수 정책 CAUTION·readiness/liveness 제목, kubectl v1.34.1 실측) · 15장 3건 · 12장 2건 · 7장 4건 · 14장 5건, 모두 전항 통과 |
| 복습 회차 (_review) | 미개시 |
