...
> 서비스 어카운트 토큰이 Pod에 어떤 방식으로 주입되는지, 토큰 모델이 어떻게 바뀌어 왔는지는 이 책이 다루지 않습니다. 그 내용은 [Kubernetes Patterns 26-01](../kubernetes-patterns/26-01.Access%20Control%20%E2%80%94%20RBAC%EC%9C%BC%EB%A1%9C%20%EB%88%84%EA%B0%80%20%EB%AC%B4%EC%97%87%EC%9D%84%20%ED%95%A0%20%EC%88%98%20%EC%9E%88%EB%8A%94%EC%A7%80.md)에 있습니다.
...
> **책 밖 보강**: 위 도식의 점선, 즉 ClusterRole을 RoleBinding으로 묶어 범위를 한 네임스페이스로 좁히는 조합은 이 책이 다루지 않습니다. 책은 두 쌍을 "거의 같고 범위만 다르다"고만 적습니다. 그러나 같은 권한 묶음을 여러 네임스페이스에서 재사용할 때 실제로 가장 많이 쓰는 형태라 도식과 치트시트에 넣었습니다.
