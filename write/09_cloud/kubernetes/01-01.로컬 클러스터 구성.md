...
related:
  - ./deepdive/01-01.로컬 클러스터 구성 점검.md
  - ./02-01.핵심 워크로드.md
...
- [로컬 클러스터 구성 점검](./deepdive/01-01.%EB%A1%9C%EC%BB%AC%20%ED%81%B4%EB%9F%AC%EC%8A%A4%ED%84%B0%20%EA%B5%AC%EC%84%B1%20점검.md) — 본 장의 점검 편, 현재 GCP K8s 클러스터 기준
- [핵심 워크로드](./02-01.핵심%20워크로드.md) — 바로 다음 장, Pod·Deployment·Service 실전
