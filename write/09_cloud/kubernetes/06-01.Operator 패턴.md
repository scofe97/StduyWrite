...
related:
  - ./deepdive/06-01.Operator 패턴 점검.md
  - ./05-02.Helm 고급.md
...
- [Operator 패턴 점검](./deepdive/06-01.Operator%20%ED%8C%A8%ED%84%B4%20점검.md) — 본 장의 점검 편, OperatorHub 탐색과 ServiceMonitor 실습
- [Helm 고급](./05-02.Helm%20고급.md) — 이전 장, 차트 개발과 템플릿 설계
