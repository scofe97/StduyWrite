...
related:
  - ./deepdive/07-02.SonarQube on K8s 점검.md
...
- [SonarQube on K8s 점검](./deepdive/07-02.SonarQube%20on%20K8s%20점검.md) — 본 장의 점검 편
- [Jenkins on K8s](./07-01.Jenkins%20on%20K8s.md) — 이전 장, CI/CD 자동화
- [ArgoCD와 GitOps](./07-03.ArgoCD와%20GitOps.md) — 다음 장
