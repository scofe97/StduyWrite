...
## 1차 이관 — Spring Security 9편 → 99_ETC/security/02_spring-security/ (2026-05-20)
...
- 영향 받은 파일: 본문 8편 신규 + `02_spring-security/README.md` MOC 갱신 + `99_ETC/security/README.md` 카운트 갱신 = 10개 파일
...
- ★★ Spring WebSocket 7편 → `10_spring/06_websocket/` 신설 후보
- ★★ Spring TDD 6편 → `10_spring/04_testing/tdd/` 하위 폴더 흡수 후보
- ★★ Spring Netty 10편 → `10_spring/05_internals/` 신설 후보
