...
- 파일명 날짜 prefix(`2026-04-19-xxx.md`) — 날짜는 프론트매터 `updated` 담당. 단 `99_ETC/` 직계는 예외로 `날짜_주제.md`를 쓴다. 순서가 없는 1회성 자료라 번호가 약속을 지키지 못하기 때문이다([99_ETC/README.md](../99_ETC/README.md))
