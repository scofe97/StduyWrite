...
related:
  - README.md
  - ../../11_spring/10_security/01-01.Spring Security 개념과 Filter Chain.md
updated: 2026-05-29
---
...
이 문서를 읽고 나면 인증과 인가를 한 문장씩으로 구분하고, RBAC 와 ABAC 가 각각 언제 맞는지 결정 트리로 답하며, HTTP 401 과 403 이 왜 다른 코드인지 설명할 수 있습니다. 구현(Spring Security Filter Chain)은 [`../../11_spring/10_security/01-01`](../../11_spring/10_security/01-01.Spring%20Security%20개념과%20Filter%20Chain.md) 으로 위임하고, 여기서는 이론만 봅니다.
