---
title: 10_security/05_network — 네트워크 계층 공격과 방어
...
상위 [10_security MOC](../README.md)의 경계 가이드는 "mTLS, TLS 핸드셰이크" 같은 네트워크 보안 주제를 이 카테고리에 두라고 적어 두었습니다. 그런데 정작 받아 줄 폴더가 없었습니다. [01_concepts/](../01_concepts/)는 인증·인가 프로토콜 이론으로 채워져 있습니다. [03_vulnerabilities/](../03_vulnerabilities/)는 OWASP 애플리케이션 계층 카탈로그입니다.
...
- [10_security MOC](../README.md) — 상위 카테고리와 경계 가이드
