...
stages = [
    ...
    ("4 · 성능 분석", "느리다는 말을 사용률·포화·오류로 쪼갠다",
     [("USE · RED · 드릴다운", "", "필수"),
      ...
      ("CPU 캐시 · cache line", "Systems Performance 6장", "추천")],
     [("throughput · tail latency · P99", "Systems Performance 2장", "필수"),
      ("coordinated omission", "", "필수"),
      ("활용률 대 압력 — PSI", "PSI 공식 문서", "필수"),
      ("flame graph · 프로파일 네 축", "Systems Performance 6장", "추천"),
      ("malloc · arena · 단편화", "", "추천"),
      ("SIMD · 벡터화", "Real-World Crypto 13장", "추천"),
      ("AVX2 · AES-NI · PCLMULQDQ", "Real-World Crypto 13장", "추천"),
      ("CPUID · lscpu · cpuinfo", "Systems Performance 6장", "추천"),
    ...
    ("5 · 관측과 보안", "증상마다 맞는 창이 다르다",
     ...
     [("capability · seccomp", "Container Security 2장", "필수"),
      ("비밀의 수명 — 생성·사용·파기", "Real-World Crypto 8장", "필수"),
      ("zeroing · explicit_bzero", "Real-World Crypto 8장", "필수"),
      ("mlock · swap · core dump 유출", "Systems Performance 7장", "추천"),
      ("상수 시간 · 사이드 채널", "Real-World Crypto 13·16장", "선택"),
      ("샌드박싱 세 갈래", "Container Security 8장", "추천"),
      ("격리 우회", "Container Security 9장", "추천"),
