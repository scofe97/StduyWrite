...
# 이 로드맵이 쓰는 자료 열여섯을 단계 순으로 걸고, 각 자료에서 "읽을 장"만 적는다.
...
rows = [
    ...
    ("1·2", "연결과 웹 프로토콜", [
        ("Computer Networking", "1단계", "1~5장", ["응용·전송·네트워크 계층", "라우팅과 SDN"], "필수"),
        ("TCP/IP Illustrated", "1·2단계", "2~8 · 10~18장", ["주소·ARP·IP·NAT·ICMP", "TCP 연결·재전송·혼잡"], "필수"),
        ("HTTP/2 in Action", "1단계", "4·8·9장", ["프레임·HPACK", "TCP·QUIC·HTTP/3"], "추천"),
        ("High Performance Browser Networking", "1단계", "2·4·11·12장", ["TCP 구성 요소·TLS", "HTTP/1.x 와 HTTP/2"], "대체"),
    ]),
    ("2–6", "계층 종주", [
    ...
    ("3·4", "관측", [
        ...
        ("Learning CoreDNS", "3·4단계", "3·6·7장", ["Corefile 과 플러그인 체인", "Kubernetes 레코드"], "추천"),
    ]),
    ("4·5", "underlay·클라우드", [
    ...
    ("7·8", "운영 경계", [
        ("Istio in Action", "7단계", "1·3·4·5·9·12장", ["Envoy·Gateway·mTLS", "기본값 닫기·Zero Trust"], "추천"),
        ("Zero Trust Networks", "7·8단계", "1·2·6·8·10장", ["신뢰 관리와 identity", "트래픽 신뢰·공격자 관점"], "추천"),
        ("Sidecar-less Istio Explained", "7단계", "전 4장", ["ambient 모드 구조", "ztunnel 과 waypoint"], "대체"),
    ]),
    ("8–9", "신뢰와 경로", [
        ("Real-World Cryptography", "8단계", "5·7~10장", ["키 교환·서명·난수", "안전한 전송과 종단 암호화"], "추천"),
        ("Patterns of Distributed Systems", "8·9단계", "7·8장", ["HeartBeat 와 실패 감지 시간", "membership 과 정족수"], "추천"),
    ]),
]
...
d = D(
    ...
    "네트워크 책 읽기 흐름",
    "이 로드맵이 쓰는 자료 열여섯을 단계 순으로 걸고 각 자료에서 읽을 장만 적었다. 통독하는 책은 셋이고 "
