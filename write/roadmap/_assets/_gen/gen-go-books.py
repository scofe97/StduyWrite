...
rows = [
    ("1–3", "언어", [
        ("Learning Go", "1~3 · 5단계", "1~11 · 13·14장", ["문법·컬렉션·값 의미론", "인터페이스·에러·제네릭·모듈"], "필수"),
        ("Learn Go with Pocket-Sized Projects", "1·2·5·6단계", "2~7장", ["작은 프로젝트로 손에 익히기", "제네릭 캐시·CLI"], "대체"),
    ]),
    ("4", "동시성", [
        ("Learn Concurrent Programming with Go", "4단계", "1~12장", ["스레드·공유·mutex·조건 변수", "채널 패턴·deadlock·atomic"], "필수"),
    ]),
    ("5", "테스트와 성능", [
        ("Learning Go", "1~3 · 5단계", "15·16장", ["테스트·커버리지", "reflect·unsafe·cgo"], "추천"),
    ]),
    ("6", "네트워크 서비스", [
