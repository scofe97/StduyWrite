...
stages = [
    ("1 · 문법", "빠르게 통과하되 값 의미론은 붙잡는다",
     ...
     [("array · slice · append", "Learning Go 3장", "필수"),
      ...
      ("작은 프로젝트로 손에 익히기", "Pocket-Sized Projects 2~5장", "선택")]),
    ...
    ("5 · 테스트와 성능", "추측 대신 재고 남길 테스트만 남긴다",
     [("table-driven test · test double", "Learning Go 15장", "필수"),
      ...
      ("goroutine profile · leak 찾기", "Go Diagnostics", "추천")],
...
NOTES = {
    ...
    5: "이 로드맵은 정독 노트가 없다. 책 줄이 유일한 자료이고, 빈 줄은 소장본도 없는 자리다.",
}
...
d = D(W, H, "WRITE · GO ROADMAP",
      "Go 학습 로드맵",
      "문법을 빠르게 통과한 뒤 값 의미론과 인터페이스로 타입을 설계하고 동시성·테스트·성능을 거쳐 "
      "네트워크 서비스로 간다. 척추에 단계 일곱을 걸고 개념을 좌우로 뻗었다. 노드의 주인공은 개념이고 아래 줄은 "
