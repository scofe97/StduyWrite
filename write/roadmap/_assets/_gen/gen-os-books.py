...
rows = [
    ("1–3", "Linux 사용", [
        ("Learning Modern Linux", "1~3단계", "1~6장", ["커널·셸·접근 제어", "파일시스템·부팅·컨테이너"], "필수"),
        ("The Linux Command Line", "1·2단계", "1~11장", ["셸·리다이렉션·권한", "프로세스와 환경"], "필수"),
    ]),
    ("1·2", "명령줄 보조", [
        ("How Linux Works", "1·2단계", "1~8장", ["장치·디스크·파일시스템", "부팅과 유저 스페이스 시작"], "추천"),
        ("Efficient Linux at the Command Line", "1단계", "1~8장", ["명령 조합·파이프라인", "부모·자식·환경"], "대체"),
    ]),
    ("1·2 · 4–6", "실행 모델", [
        ("Operating System Concepts", "1·2·4~6단계", "1~16장", ["프로세스·스레드·동기화", "스케줄링·메모리·저장·보안"], "추천"),
        ("OSTEP (무료 공개판)", "2·4·6단계", "가상화 · 병행성 · 지속성", ["프로세스·스케줄링·주소 공간", "페이징·TLB·파일시스템"], "필수"),
    ]),
    ("3", "컨테이너 기반", [
        ("Container Security", "3·5단계", "2~4장", ["시스템 콜·권한·capability", "cgroup·namespace·루트"], "필수"),
    ]),
    ("4", "성능 분석", [
        ("Systems Performance", "4·5단계", "2 · 6~9장", ["방법론 20종·USE", "CPU·메모리·파일시스템·디스크"], "필수"),
        ("Real-World Cryptography", "4·5단계", "13장", ["SIMD·벡터화", "AES-NI·PCLMULQDQ"], "추천"),
    ]),
    ("3–5", "Linux 인터페이스", [
        ("Linux Kernel Docs (공식)", "3~5단계", "proc · cgroup-v2 · psi", ["/proc/stat·meminfo·PID", "cgroup v2 파일과 PSI"], "필수"),
    ]),
    ("5", "관측", [
        ("Systems Performance", "4·5단계", "4 · 13~15장", ["관측 도구 커버리지", "perf·Ftrace·BPF"], "필수"),
        ("Real-World Cryptography", "4·5단계", "8 · 13 · 16장", ["난수와 비밀의 수명", "하드웨어 암호·사이드 채널"], "추천"),
        ("Learning eBPF", "5단계", "3 · 5~7 · 9장", ["프로그램 구조·CO-RE·BTF", "verifier·보안"], "추천"),
    ]),
    ("5", "격리 강화", [
        ("Container Security", "3·5단계", "8·9장", ["샌드박싱 세 갈래", "설정 하나로 무너지는 경계"], "추천"),
    ]),
    ("2 · 6", "커널 내부", [
        ("Linux Kernel Programming", "2·6단계", "6~13장", ["메모리 관리·할당자", "스케줄러·동기화"], "추천"),
    ]),
    ("6", "가상화", [
        ("Virtualization Essentials", "6단계", "1~3 · 7·8장", ["하이퍼바이저와 VM", "CPU·메모리 배분"], "선택"),
        ("Mastering KVM Virtualization", "6단계", "1·2 · 15장", ["Linux 가상화와 KVM", "성능 튜닝"], "대체"),
    ]),
]
...
d = D(
    ...
    "WRITE · OS BOOK FLOW",
    "OS 책 읽기 흐름",
    "이 로드맵이 쓰는 책과 공식 문서를 단계 순으로 걸고 각 책에서 읽을 장만 적었다. 통독하는 책은 없다. "
