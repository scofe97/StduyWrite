...
related:
  - README.md
  - 03_jwt-design.md
  - ../../../10_spring/10_security/02-01.OAuth2 개념과 흐름.md
updated: 2026-05-29
---
...
> OAuth2 는 본질적으로 *인가 위임* 프로토콜입니다. "내 비밀번호를 주지 않고도 이 앱이 내 자원에 접근하게 허락한다" 가 핵심입니다. 그런데 많은 서비스가 이걸 *로그인* 에 쓰면서 혼란이 생겼고, 그 빈 자리를 메우려고 OIDC 가 OAuth2 위에 인증 계층을 얹었습니다. 본 문서는 프로토콜 이론으로 둘을 가릅니다. Spring 구현은 [`../../10_spring/10_security/02-01`](../../../10_spring/10_security/02-01.OAuth2%20%EA%B0%9C%EB%85%90%EA%B3%BC%20%ED%9D%90%EB%A6%84.md) 으로 위임합니다.
