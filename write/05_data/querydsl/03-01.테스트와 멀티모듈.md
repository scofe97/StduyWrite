...
`annotationProcessor` 키워드 자체와 `implementation`·`compileOnly` 등 다른 Gradle 의존 키워드의 *분리된 classpath* 의미는 [`../../01_language/java/06_Build/02-01.Gradle 의존성 키워드.md`](../../01_language/java/06_Build/02-01.Gradle%20의존성%20키워드.md) 의 §6~7 에 카탈로그로 정리돼 있습니다. 본 챕터는 그 토대 위에서 *QueryDSL 한정* 관점만 짚습니다.
