...
- [연관관계 매핑](02-02.%EC%97%B0%EA%B4%80%EA%B4%80%EA%B3%84%20%EB%A7%A4%ED%95%91.md) — `@ManyToOne`/`@OneToMany` 의 fetch 기본값과 방향 설계
- [쿼리 메소드](03-02.%EC%BF%BC%EB%A6%AC%20%EB%A9%94%EC%86%8C%EB%93%9C.md) — Fetch Join, `@EntityGraph` 의 실제 선언 방법
