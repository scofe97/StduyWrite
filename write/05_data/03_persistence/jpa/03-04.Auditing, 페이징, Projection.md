...
- [공통 인터페이스](03-01.Spring%20Data%20JPA%20%EA%B3%B5%ED%86%B5%20%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4.md) — `JpaRepository` 기본 제공 메서드 위에 본 문서의 확장 기능이 얹힘
- [쿼리 메소드](03-02.%EC%BF%BC%EB%A6%AC%20%EB%A9%94%EC%86%8C%EB%93%9C.md) — 페이징·Projection 이 결합되는 쿼리 메서드와 `@Query` 의 기초
