...
related:
  - ../../02_relational/postgres/02-03.성능 모니터링.md
...
- 두 delegator 의 채널 raw 로그 예시·log4j2 갈래를 끼는 두 가지 정합 조건은 [04-02.md §5 (3) logback logger level](04-02.log4jdbc%20%EB%A1%9C%EA%B7%B8%20%EC%A0%9C%EC%96%B4%20%EB%B2%A0%EC%8A%A4%ED%8A%B8%20%ED%94%84%EB%9E%99%ED%8B%B0%EC%8A%A4.md) 와 [04-02a.md §3 라우팅·드라이버](04-02a.log4jdbc%20properties%20%EB%A0%88%ED%8D%BC%EB%9F%B0%EC%8A%A4.md) 에 더 자세히 정리돼 있습니다.
...
>
> - 외과성(다른 코드 영향 최소화)과 평가 비용은 반비례하며 — 가장 강한 driver 차단은 SQL 디버깅까지 잃고, 가장 외과적인 EvaluatorFilter 는 매 이벤트 Janino 식 평가 비용을 받습니다. 본 절은 네 자리의 *명명과 trade-off* 만 박고, 레이어별 deep-dive·예시·실측 비용·executor 처방은 [04-02.md §2~§9](04-02.log4jdbc%20%EB%A1%9C%EA%B7%B8%20%EC%A0%9C%EC%96%B4%20%EB%B2%A0%EC%8A%A4%ED%8A%B8%20%ED%94%84%EB%9E%99%ED%8B%B0%EC%8A%A4.md) 에 모았습니다.
...
|---|---|---|---|---|---|
| (4.1) Driver 차단 | log4jdbc | wrap 채널 *생성 전* | 0 | 모든 SQL 디버깅 | [04-02 §3](04-02.log4jdbc%20%EB%A1%9C%EA%B7%B8%20%EC%A0%9C%EC%96%B4%20%EB%B2%A0%EC%8A%A4%ED%8A%B8%20%ED%94%84%EB%9E%99%ED%8B%B0%EC%8A%A4.md) |
| (4.2) properties | log4jdbc | wrap 채널 *내부 형식* | 0 | 없음 (형식만 정돈) | [04-02 §4](04-02.log4jdbc%20%EB%A1%9C%EA%B7%B8%20%EC%A0%9C%EC%96%B4%20%EB%B2%A0%EC%8A%A4%ED%8A%B8%20%ED%94%84%EB%9E%99%ED%8B%B0%EC%8A%A4.md) · [04-02a 전체](04-02a.log4jdbc%20properties%20%EB%A0%88%ED%8D%BC%EB%9F%B0%EC%8A%A4.md) |
| (4.3) logger level | logback | ILoggingEvent *생성 전* | ~0μs | 해당 logger 이름 전체 | [04-02 §5](04-02.log4jdbc%20%EB%A1%9C%EA%B7%B8%20%EC%A0%9C%EC%96%B4%20%EB%B2%A0%EC%8A%A4%ED%8A%B8%20%ED%94%84%EB%9E%99%ED%8B%B0%EC%8A%A4.md) |
| (4.4) EvaluatorFilter | logback | ILoggingEvent *생성 후* | 0.3~1.5μs/이벤트 | 조건 외 영향 0 (외과적) | [04-02 §6 · §7](04-02.log4jdbc%20%EB%A1%9C%EA%B7%B8%20%EC%A0%9C%EC%96%B4%20%EB%B2%A0%EC%8A%A4%ED%8A%B8%20%ED%94%84%EB%9E%99%ED%8B%B0%EC%8A%A4.md) |
