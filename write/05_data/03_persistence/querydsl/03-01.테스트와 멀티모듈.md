...
- [11_spring/04_testing/01-01. 테스트 피라미드와 Spring 테스트 종류](../../../11_spring/04_testing/01-01.테스트 피라미드와 Spring 테스트 종류.md) — `@DataJpaTest`·슬라이스가 전체 테스트 계층에서 차지하는 위치 (본 문서의 JPA 슬라이스를 더 넓은 맥락에서 봄)
