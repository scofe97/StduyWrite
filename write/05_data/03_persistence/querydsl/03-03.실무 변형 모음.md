...
- [01-03. 기본 문법과 조인](01-03.%EA%B8%B0%EB%B3%B8%20%EB%AC%B8%EB%B2%95%EA%B3%BC%20%EC%A1%B0%EC%9D%B8.md) — Q-class 표준 패턴과의 비교 출발점
- [01-04. 동적 쿼리](01-04.%EB%8F%99%EC%A0%81%20%EC%BF%BC%EB%A6%AC.md) — `BooleanBuilder` vs `BooleanExpression`, 추상 베이스 도입 전 단계
- [01-05. 프로젝션과 DTO 매핑](01-05.%ED%94%84%EB%A1%9C%EC%A0%9D%EC%85%98%EA%B3%BC%20DTO%20%EB%A7%A4%ED%95%91.md) — `Projections.constructor` 표준, `nullExpression`은 그 변형
- [01-06. 페이징과 fetch join 함정](01-06.%ED%8E%98%EC%9D%B4%EC%A7%95%EA%B3%BC%20fetch%20join%20%ED%95%A8%EC%A0%95.md) — 두 단계 fetch 패턴이 페이징·페치 조인 함정에서도 같은 모양
- [jpa/03-05. 커스텀 리포지토리 패턴](../jpa/03-05.%EC%BB%A4%EC%8A%A4%ED%85%80%20%EB%A6%AC%ED%8F%AC%EC%A7%80%ED%86%A0%EB%A6%AC%20%ED%8C%A8%ED%84%B4.md) — fragment 패턴과 외과적 변경 정책의 분기점
