...
2. **Q-class import 가 어려운 모듈 경계** — *Q-class 로는 불가능에 가까운 유일한 자리*. 
   ...
   - 다만 PathBuilder 가 *유일한* 해법은 아니다. 모듈 구조를 손볼 수 있다면 "도메인 모듈에서 Q-class 를 빌드해 공유" 하는 정공법이 있고, 그 셋업·함정은 [03-02 § 멀티모듈 해결 패턴](03-01.%ED%85%8C%EC%8A%A4%ED%8A%B8%EC%99%80%20%EB%A9%80%ED%8B%B0%EB%AA%A8%EB%93%88.md) 이 다룬다. PathBuilder 는 *모듈 구조를 못 건드릴 때* 의 우회로다.
...
- [01-01. QueryDSL 입문과 6.12의 위치](01-01.QueryDSL%20%EC%9E%85%EB%AC%B8%EA%B3%BC%206.12%EC%9D%98%20%EC%9C%84%EC%B9%98.md) § "Q클래스 없이도 가능한가" — PathBuilder 의 짧은 도입
- [01-03. 기본 문법과 조인](01-03.%EA%B8%B0%EB%B3%B8%20%EB%AC%B8%EB%B2%95%EA%B3%BC%20%EC%A1%B0%EC%9D%B8.md) § "별칭 충돌과 자기 참조 조인" — Q-class 두 번째 인스턴스로 푸는 동일 문제
...
- [03-03. 실무 변형 모음](03-03.%EC%8B%A4%EB%AC%B4%20%EB%B3%80%ED%98%95%20%EB%AA%A8%EC%9D%8C.md) § "PathBuilder 기반 메타모델" — Q-class 회피 / EmbeddedId / 상관 서브쿼리 / 동적 검색 추상 베이스 응용
- [03-05. window 함수 없는 JPA QueryDSL의 ROW_NUMBER 대체](03-05.window%20%ED%95%A8%EC%88%98%20%EC%97%86%EB%8A%94%20JPA%20QueryDSL%EC%9D%98%20ROW_NUMBER%20%EB%8C%80%EC%B2%B4.md) — PathBuilder 3 개가 한 SQL 패턴에 결합되는 사례 통째 분해
