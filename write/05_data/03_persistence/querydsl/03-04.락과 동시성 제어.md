...
> 본 락·동시성 문서가 묶음 내 다른 챕터와 어떻게 연결되는지. `setLockMode` 와 BooleanExpression 분해 결합은 01-04, 부모 카테고리 05_data 의 트랜잭션 격리 수준은 외부 문서로 이어진다.

- [01-04.동적 쿼리](01-04.%EB%8F%99%EC%A0%81%20%EC%BF%BC%EB%A6%AC.md) — `setLockMode` 를 BooleanExpression 분해와 결합하는 패턴
- [jpa/03-05.커스텀 리포지토리 패턴](../jpa/03-05.%EC%BB%A4%EC%8A%A4%ED%85%80%20%EB%A6%AC%ED%8F%AC%EC%A7%80%ED%86%A0%EB%A6%AC%20%ED%8C%A8%ED%84%B4.md) — Custom Impl 에 락 메서드 위치
- [03-03.실무 변형 모음](03-03.%EC%8B%A4%EB%AC%B4%20%EB%B3%80%ED%98%95%20%EB%AA%A8%EC%9D%8C.md) — 상관 서브쿼리·PathBuilder 와 락 결합 변형
