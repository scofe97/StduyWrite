...
---
> Martin Kleppmann & Chris Riccomini 의 2판을 장별로 정독한 노트입니다. 장 번호가 바뀐 별개 판본이라 1판 요약([01_foundation](../../01_foundation/README.md))과 분리해, 합니다체 + 핵심 요약 SVG + Mermaid 로 쌓습니다.
...
| 1장 | [01-01 운영 시스템 vs 분석 시스템](01-01.%EC%9A%B4%EC%98%81%20%EC%8B%9C%EC%8A%A4%ED%85%9C%20vs%20%EB%B6%84%EC%84%9D%20%EC%8B%9C%EC%8A%A4%ED%85%9C.md) — 기록/파생 포함 | ✅ |
...
> 1장 — Trade-Offs in Data Systems Architecture. 네 트레이드오프 축(운영·분석 및 기록·파생 · 클라우드/셀프 · 분산/단일 · 비즈니스/사용자 권리)을 절별로 나눠 정독했습니다. 종합은 [01-05 §4](01-05.%EB%8D%B0%EC%9D%B4%ED%84%B0%20%EC%8B%9C%EC%8A%A4%ED%85%9C%C2%B7%EB%B2%95%C2%B7%EC%82%AC%ED%9A%8C.md).
>
