...
이 노트는 [05-02](05-02.JSON%C2%B7XML%C2%B7%EC%9D%B4%EC%A7%84%20%EB%B3%80%ED%98%95.md)에 이어, 스키마로 이진 인코딩을 기술하는 Protocol Buffers와 Avro를 다룹니다. 둘 다 같은 레코드를 텍스트 JSON의 절반 이하 바이트로 인코딩합니다.
...
요약하면 스키마 진화는 schemaless/schema-on-read JSON 데이터베이스([03-04](03-04.%EB%AA%A8%EB%8D%B8%20%EC%84%A0%ED%83%9D%EA%B3%BC%20%EC%8A%A4%ED%82%A4%EB%A7%88%20%EC%9C%A0%EC%97%B0%EC%84%B1.md))와 같은 유연성을 주면서, 데이터에 대한 더 나은 보장과 도구를 제공합니다. 다만 운영을 단순하게 유지하려 동시 스키마 형식 수는 최소로 두는 것이 좋습니다.
...
- [05-02 JSON·XML·이진 변형](05-02.JSON%C2%B7XML%C2%B7%EC%9D%B4%EC%A7%84%20%EB%B3%80%ED%98%95.md) § "이진 인코딩" — 스키마로 필드명을 빼는 동기
- [05-04 데이터플로우 — DB·REST·RPC](05-04.%EB%8D%B0%EC%9D%B4%ED%84%B0%ED%94%8C%EB%A1%9C%EC%9A%B0%20%E2%80%94%20DB%C2%B7REST%C2%B7RPC.md) — 이 인코딩이 DB·서비스·메시지로 흐르는 방식
- [03-04 모델 선택과 스키마 유연성](03-04.%EB%AA%A8%EB%8D%B8%20%EC%84%A0%ED%83%9D%EA%B3%BC%20%EC%8A%A4%ED%82%A4%EB%A7%88%20%EC%9C%A0%EC%97%B0%EC%84%B1.md) § "schema-on-read vs schema-on-write" — 스키마 진화와 유연성의 관계
