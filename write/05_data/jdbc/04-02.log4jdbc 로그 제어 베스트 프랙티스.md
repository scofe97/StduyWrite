...
log4jdbc-log4j2 공식 properties 20개 중 운영에서 실제로 만지는 6개만 추려서 봅니다. 공식 20개 전체 옵션(타이밍 임계·SQL 종류 토글·출력 정형 등)은 [04-02a.log4jdbc properties 레퍼런스](04-02a.log4jdbc%20properties%20레퍼런스.md)에 카테고리별로 정리돼 있습니다.
