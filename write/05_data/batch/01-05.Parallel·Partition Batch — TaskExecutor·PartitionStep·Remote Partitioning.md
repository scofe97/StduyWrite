...
- [`../../08_cloud/kubernetes/05-07.배치 워크로드.md`](../../08_cloud/kubernetes/05-07.배치%20워크로드.md) — Remote Partitioning 의 worker JVM 들을 K8s Job 으로 띄울 때의 자원 관리·실패 처리. Spring Batch 의 *논리적 병렬* 이 K8s 의 *물리적 스케줄링* 과 만나는 지점
