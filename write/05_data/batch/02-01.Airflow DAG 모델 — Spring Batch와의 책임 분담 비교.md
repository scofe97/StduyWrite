...
- [`../../08_cloud/kubernetes/09-03.배치 워크로드.md`](../../08_cloud/kubernetes/09-03.배치%20워크로드.md) — Airflow KubernetesExecutor 또는 Argo Workflows 가 *K8s 위에서* 도는 방법. 각 Task 를 K8s Pod 로 띄울 때의 자원 관리·실패 처리
