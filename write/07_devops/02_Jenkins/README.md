...
전문가 로드맵의 학습 주제를 기존 7폴더에 매핑한 표입니다. *커버* 열은 우리 자료가 그 주제를 얼마나 다루는지입니다 — ✅ 충분 / △ 부분 / ❌ 미작성. 라벨은 110편 본문을 전수 grep 해 판정했습니다(아래 "검증 방법" 참조). *주의* 열에 실측으로 드러난 미작성·얕은 세부 키워드를 적었습니다.

| # | 학습 주제 | 담당 폴더 | 커버 | 주의 (실측 미작성·얕음) |
|---|----------|----------|:----:|------------------|
| 1 | 기본 구조 (Controller·Agent·Executor·Queue·Label) | [01_core/](01_core/README.md) | ✅ | — |
| 2 | 빌드 잡 유형 (Freestyle·Pipeline·Multibranch·Org Folder·Matrix) | [01_core/](01_core/README.md) · [06_infra/](06_infra/README.md) | △ | Freestyle·Pipeline·Multibranch ✅ / **Organization Folder 곁다리 2편**, **Matrix *Job*(`matrix{}` axes)은 거의 없음**(hit은 Matrix-*권한*) |
| 3 | Pipeline (Declarative·Scripted·step·stage·post·when·parallel) | [01_core/](01_core/README.md) | ✅ | — |
| 4 | SCM·트리거 (Webhook·Generic Webhook·Poll SCM·cron) | [04_api/](04_api/README.md) · [05_operations/](05_operations/README.md) | △ | Webhook·Generic Webhook ✅ / **Poll SCM 트리거**·**cron `H` 분산 문법**은 곁다리(폴링 hit 대부분은 *API 상태 폴링*) |
| 5 | Jenkinsfile 작성 (재현성·실패 추적·withCredentials) | [01_core/](01_core/README.md) · [02_security/](02_security/README.md) | ✅ | — |
| 6 | Shared Library (vars·src·resources·Trusted) | [05_operations/](05_operations/README.md) | ✅ | — |
| 7 | Agent 운영 (Static·SSH·Inbound·Docker·K8s) | [03_agent/](03_agent/README.md) | ✅ | Static·SSH·Inbound(JNLP)·Docker·K8s ✅(03_agent 01-01 연결방식·정적/동적 대비) / **Windows Agent(bat/powershell)는 전용 절 없음** — 특수노드 예시·Kaniko 미지원 언급만 |
| 8 | 보안 (인증·인가·Matrix·Script Approval·Agent→Controller) | [02_security/](02_security/README.md) | ✅ | — |
| 9 | Credential (Scope·withCredentials·Masking 한계) | [02_security/](02_security/README.md) · [04_api/](04_api/README.md) | ✅ | "Credential Binding *Plugin*" 명칭은 미등장(개념은 다수) |
| 10 | Plugin 관리 (의존성·LTS 호환·CasC catalog) | [06_infra/](06_infra/README.md) · [07_engine/](07_engine/README.md) | △ | **Update Center · Detached plugin ❌** |
| 11 | 운영 관리 (Backup·Restore·Upgrade·Log·Disk) | [05_operations/](05_operations/README.md) | △ | Backup/Restore·Upgrade 전용편 없음, 디스크 풀 1편(곁다리) |
| 12 | JVM 튜닝 (Xmx·G1GC·Heap·Thread dump) | [06_infra/](06_infra/README.md) | △ | 용량 산정·Heap dump 2편(산정 문맥)만 있음 / **Thread dump·Metaspace·Safepoint ❌**, GC log 1편 |
| 13 | 빌드 도구 (Gradle·SonarQube·Jacoco·Kaniko·Trivy) | [03_agent/](03_agent/README.md) · [06_infra/](06_infra/README.md) | ✅ | **SBOM ❌**, Checkstyle/PMD/SpotBugs 1편 |
| 14 | Docker / Kubernetes 연동 (Pod Template·RBAC·Kaniko) | [03_agent/](03_agent/README.md) | ✅ | **Node Selector/Toleration ❌** · ImagePullSecret 1편 · Namespace 분리 얕음 |
| 15 | 배포 전략 (Blue-Green·Canary·GitOps·ArgoCD) | [06_infra/](06_infra/README.md) | ✅ | Feature Flag 1편(얕음) |
| 16 | 관찰성 (Metrics·빌드 추세·감사 로그·Observability) | [05_operations/](05_operations/README.md) · [06_infra/](06_infra/README.md) | △ | Prometheus·감사 로그 ✅ / **OpenTelemetry ❌**, **빌드 지표·추세(trend) ❌** |
| 17 | 멀티 테넌시·조직 분리 (Folder 격리·Team) | [06_infra/](06_infra/README.md) | △ | Folder 격리 ✅ / **멀티 테넌시(multi-tenant) ❌**, Team 분리 1편 |
| 18 | 장애 대응 (Queue 적체·UI 느림·Thread dump 루틴) | [05_operations/](05_operations/README.md) · [06_infra/](06_infra/README.md) | ❌ | 증상→의심지점 runbook 전용편 없음 |
| 19 | API / 자동화 (Crumb·Token·Webhook·CLI) | [04_api/](04_api/README.md) | ✅ | — |
| 20 | 성능·스케일링 (Controller 부하·동적 Agent·discard) | [06_infra/](06_infra/README.md) · [07_engine/](07_engine/README.md) | ✅ | Cloud EC2/Fleet은 곁다리(본문 Azure VM) |
