...
| 5 | Agent 운영 (Static·SSH·Inbound·Docker·K8s) | [03_agent/](03_agent/README.md) | ✅ | Windows Agent(bat/powershell)는 전용 절 없음 — incidental 언급만 |
| 6 | 보안 (인증·인가·Matrix·Script Approval·Agent→Controller) | [02_security/](02_security/README.md) | ✅ | — |
| 7 | Credential (Scope·withCredentials·Masking 한계) | [02_security/](02_security/README.md) · [04_api/](04_api/README.md) | ✅ | "Credential Binding *Plugin*" 명칭은 미등장(개념은 다수) |
| 8 | Plugin 관리 (의존성·LTS 호환·CasC catalog) | [06_infra/](06_infra/README.md) · [07_engine/](07_engine/README.md) | △ | **Update Center · Detached plugin ❌** |
| 9 | 운영 관리 (Backup·Restore·Upgrade·Log·Disk) | [05_operations/](05_operations/README.md) | △ | Backup/Restore·Upgrade 전용편 없음 |
| 10 | JVM 튜닝 (Xmx·G1GC·Heap·Thread dump) | [06_infra/](06_infra/README.md) | △ | 용량 산정·Heap dump만 있음 / **Thread dump·Metaspace·Safepoint ❌**, GC log 1편 |
| 11 | 빌드 도구 (Gradle·SonarQube·Jacoco·Kaniko·Trivy) | [03_agent/](03_agent/README.md) · [06_infra/](06_infra/README.md) | ✅ | **SBOM ❌**, Checkstyle/PMD/SpotBugs 1편 |
| 12 | Docker / Kubernetes 연동 (Pod Template·RBAC·Kaniko) | [03_agent/](03_agent/README.md) | ✅ | Node Selector/Toleration·Namespace 분리는 각 1편(얕음) |
| 13 | 배포 전략 (Blue-Green·Canary·GitOps·ArgoCD) | [06_infra/](06_infra/README.md) | ✅ | Feature Flag 1편(얕음) |
| 14 | 장애 대응 (Queue 적체·UI 느림·Thread dump 루틴) | [05_operations/](05_operations/README.md) · [06_infra/](06_infra/README.md) | ❌ | 증상→의심지점 runbook 전용편 없음 |
...
8·9·10 은 △, 14 는 ❌ 이고, ✅ 주제 안에도 위 *주의* 열의 세부 키워드는 미작성이거나 1편뿐입니다. 보강 후보는 아래 "아직 얕거나 빈 주제" 절에 모았습니다.
...
|---------------|----------------|----------|
| 장애 대응 runbook (증상 → 의심 지점 표 + 분석 루틴 10단계) | 횡단 주제 — 기존 어느 편에도 안 맞음, 가장 큰 공백 | `05_operations/` 신규 |
...
| Backup / Restore · LTS Upgrade 절차 | 내구성(01-01)과 다른 *운영 절차* — 전용편 없음 | `05_operations/` 신규 |
