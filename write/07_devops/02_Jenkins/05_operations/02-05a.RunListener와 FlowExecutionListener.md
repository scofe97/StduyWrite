...
>
> Job/Agent/Credentials/큐/알림 등 Groovy 로 만질 수 있는 영역을 카테고리별로 모은 레퍼런스는 [02-04a. Groovy로 Jenkins 내부 조회하기](02-04a.Groovy%EB%A1%9C%20Jenkins%20%EB%82%B4%EB%B6%80%20%EC%A1%B0%ED%9A%8C%ED%95%98%EA%B8%B0.md) § "Groovy 커스터마이징 카탈로그" 로 옮겨 정리했습니다. 이 문서는 *리스너* 에 집중합니다.
