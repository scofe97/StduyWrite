...
> - `PAUSED_PENDING_INPUT` 해석, 승인자 제어, readiness 정책, TPS 운영 패턴은 `05-08a`에서 별도로 다룬다.
...
모든 예시는 [05-00. 젠킨스 API 사전 준비.md](/Users/simbohyeon/Library/CloudStorage/GoogleDrive-tscofet@gmail.com/내%20드라이브/study/runners-high/write/07_devops/02_Jenkins/05-00.%20젠킨스%20API%20사전%20준비.md) 와 `05-02`까지의 준비가 끝났다는 전제다.
...
현재 환경처럼 비밀번호 인증을 쓴다면 POST 전에 crumb과 cookie도 같이 준비해야 한다. 이 문서의 POST 예시는 `05-02`에서 발급한 crumb과 session cookie를 그대로 사용한다.
...
- `05-02a. 젠킨스 인증 모델과 TPS 패턴 (2.222+).md`
- `05-05. 젠킨스 빌드 상태 추적 API 스펙.md`
- `05-08a. 젠킨스 API 배포 승인과 운영 관리 현대화.md`
