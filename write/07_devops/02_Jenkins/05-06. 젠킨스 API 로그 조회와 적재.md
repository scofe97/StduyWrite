...
> - 로그 적재 구현 패턴, 파일 저장 구조, 모듈 역할 분리, 최근 버전 변화는 `05-06a`에서 별도로 다룬다.
...
모든 예시는 [05-00. 젠킨스 API 사전 준비.md](/Users/simbohyeon/Library/CloudStorage/GoogleDrive-tscofet@gmail.com/내%20드라이브/study/runners-high/write/07_devops/02_Jenkins/05-00.%20젠킨스%20API%20사전%20준비.md) 와 `05-04`, `05-05`까지의 준비가 끝났다는 전제다.
