...
- [06-01. Jenkins 서버 용량 산정과 시스템 요구사항](01-01.Jenkins%20서버%20용량%20산정과%20시스템%20요구사항.md) § "추정 휴리스틱" — 배포 형태 결정 전 필요 자원 추정 방법
- [06-03. IaC로 Jenkins 배포](01-03.IaC로%20Jenkins%20배포%20%E2%80%94%20Terraform%C2%B7JCasC%C2%B7Helm.md) § "코드화 3계층" — 배포 이후 설정 코드화로 신뢰성을 끌어올리는 방법
