...
Jenkins Pipeline의 `stage` 구조와 Helm 기본 개념을 알고 있으면 좋습니다. Helm으로 Jenkins를 배포하는 흐름은 [`06-03.IaC로 Jenkins 배포 — Terraform·JCasC·Helm`](06-03.IaC%EB%A1%9C%20Jenkins%20%EB%B0%B0%ED%8F%AC%20%E2%80%94%20Terraform%C2%B7JCasC%C2%B7Helm.md)에서 다루고 있으며, 이 편은 동일 클러스터에 SonarQube를 추가로 올리는 시나리오를 따릅니다.
...
- [06-03. IaC로 Jenkins 배포 — Terraform·JCasC·Helm](06-03.IaC%EB%A1%9C%20Jenkins%20%EB%B0%B0%ED%8F%AC%20%E2%80%94%20Terraform%C2%B7JCasC%C2%B7Helm.md) § "K8s — Helm chart로 배포" — 동일 클러스터에 Jenkins를 올리는 Helm 배포 흐름
