...
> 다루는 문서: 06-01.용량 산정과 시스템 요구사항, 06-02.배포 시나리오와 Well-Architected 평가, 06-03.IaC로 Jenkins 배포

> 이 점검을 마치면 controller의 자원 소비 지점을 설명하고, 책 추정식의 한계를 짚으며, 5가지 배포 형태를 6 pillars로 평가하고, JCasC 3종 파일의 순서 의존성을 구분하며, Terraform 실행 흐름을 예측할 수 있는지 스스로 검증합니다.
