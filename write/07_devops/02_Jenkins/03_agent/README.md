...
| 01 Agent·컨테이너 | 01-03 | [컨테이너 이미지 빌드](01-03.컨테이너%20이미지%20빌드.md) | Dockerfile, multi-stage, 캐시 전략, 레지스트리 푸시 |
| 01 Agent·컨테이너 | 01-03a | [VM Jenkins에서의 Docker 보안 모델](01-03a.VM%20Jenkins에서의%20Docker%20보안%20모델.md) | docker.sock 노출 위험, rootless, DinD vs DooD |
| 01 Agent·컨테이너 | 01-04 | [빌드 도구 비교와 선택](01-04.빌드%20도구%20비교와%20선택.md) | Docker, Buildah, Kaniko, BuildKit — 권한·캐시·속도 트레이드오프 |
...
처음 진입자는 01-01 부터 순서대로 따라가면 됩니다. 이미 VM 위 Docker Agent 를 쓰고 있다면 01-03a 의 보안 모델로 자기 환경의 노출 지점을 점검합니다. K8s 환경이라면 02-01·02-02 로 직진한 뒤, 막히면 01-04 의 빌드 도구 비교로 돌아옵니다.
