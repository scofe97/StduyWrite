...
> **주의**: Blue Ocean은 공식 문서 기준 2026년 7월 폐기 예정이며, 이후 보안 수정·기능 업데이트를 받지 않습니다 (출처: jenkins.io/doc/book/blueocean). 그래서 step 로그가 꼭 필요한 *기존* 화면에만 Blue Ocean을 한정하고, 신규 의존은 wfapi(`flow node` 단위)를 우선합니다. Blue Ocean과 wfapi의 계층 차이·구현 선택 판단은 [07-03. wfapi 로그 모델과 Blue Ocean 구현 판단](07-03.wfapi%20로그%20모델과%20Blue%20Ocean%20구현%20판단.md)에서 다룹니다.
