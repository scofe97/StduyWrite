...
> - 로그 적재 구현 패턴, 파일 저장 구조, 모듈 역할 분리, 최근 버전 변화는 `07-01`에서 별도로 다룹니다.
...
- `07-02.wfapi 상세 스펙과 활용.md` — `wfapi` endpoint 집합과 필드 스펙
- `07-03.wfapi 로그 모델과 Blue Ocean 구현 판단.md` — Blue Ocean 구현 판단과 로그 적재 전략
