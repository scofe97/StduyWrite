...
> **읽기 전 주의**: Blue Ocean은 공식 문서 기준 2026년 7월 폐기 예정이라(출처: jenkins.io/doc/book/blueocean), 이 절의 `/blue/rest/` 드릴다운을 *신규* 구현의 1차 경로로 삼지 않는 편이 안전합니다. 폐기 이유와 `wfapi`로의 전환 판단은 [07-02 §6-1](07-02.wfapi%20상세%20스펙과%20활용.md)에 정리해 두었습니다. 이 절은 step 단위 로그가 꼭 필요한 *기존* 화면을 이해·유지보수하기 위한 참고로 읽습니다.
...
Blue Ocean은 공식 문서 기준 2026년 7월 폐기 예정이라(출처: jenkins.io/doc/book/blueocean) `/blue/rest/` 로그 경로에 신규 의존을 새로 묶지 않는 편이 안전합니다. Blue Ocean 의존도 판단은 `07-03`(wfapi 로그 모델과 Blue Ocean 구현 판단)에 정리해 두었습니다.
