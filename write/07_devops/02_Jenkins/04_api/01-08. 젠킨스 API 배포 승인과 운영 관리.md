...
>
> - 승인 대기 조회, 승인, 거절, 시스템 정보 조회, 노드 조회, Metrics Plugin 기반 헬스체크 API를 다룬입니다.
> - `PAUSED_PENDING_INPUT` 해석, 승인자 제어, readiness 정책, TPS 운영 패턴은 `01-08a`에서 별도로 다룬입니다.
...
승인 대기 상태를 만드는 빌드 실행과 상태 추적은 이 문서 범위가 아닙니다. 그 내용은 별도 문서에서 다룬입니다:
