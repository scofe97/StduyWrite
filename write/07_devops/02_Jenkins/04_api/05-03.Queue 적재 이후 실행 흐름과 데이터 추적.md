...
- `03-01.빌드 요청에서 실행까지.md` — queueId/buildNumber 흐름, 값 타임라인, 자동화 함정
- `05-01.md` — 빌드 실행 API 스펙
- `05-02.md` — Pre-trigger Guard, nextBuildNumber, Queue 운영 판단 (TPS 패턴)
- `05-04.md` — 큐 내부 메커니즘 (상태 전이, maintain 루프, createExecutable, Quiet Period)
- `06-01.md` — 빌드 상태 추적 API
