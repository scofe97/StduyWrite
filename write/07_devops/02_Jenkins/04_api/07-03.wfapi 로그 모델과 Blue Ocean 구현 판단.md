...
- `07-01.API 로그 조회와 적재.md` — 전체 로그와 `wfapi/log`를 함께 설명합니다.
- `07-01.API 로그 조회와 적재.md` — 전체 로그 적재와 버전 변화(Blue Ocean 축소 포함)를 정리합니다.
- `07-02.wfapi 상세 스펙과 활용.md` — `wfapi` endpoint 집합과 필드 스펙을 정리합니다.
