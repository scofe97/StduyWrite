...
>
> - 서버 URL, 계정, 공통 파일명, 실습용 리소스 이름, 기본 응답 확인 규칙을 다룹니다.
> - 개별 API 호출과 인증 흐름 자체는 각 스펙 문서에서 다룹니다.
...
> `01-02`부터 `01-08`까지의 문서에서 반복되는 공통 준비를 한 곳으로 모읍니다. 같은 설정을 문서마다 다시 쓰지 않으려는 것입니다.
>
...
> - 각 방식의 상세 스펙과 이론은 `01-02`, `01-02a`, `01-02b`에서 다룹니다.
...
- `JENKINS_PASS` 대신 `API_TOKEN`을 사용한다는 점만 다릅니다. curl 문법은 동일합니다.
