...
## Q1: JCasC에서 UI 변경과 YAML 충돌이 발생하면 어떻게 됩니까?

> 답은 §정답 절을 참조합니다.

### 심화

`jenkins.yaml`을 Git으로 관리할 때 환경별(dev/prod) 값 분기 전략 3가지는 무엇입니까?

## Q2: Secret Source를 선택하는 기준은 무엇입니까?

> 답은 §정답 절을 참조합니다.

### 심화

Docker Secrets와 K8s Secrets를 동시에 사용해야 하는 상황이 있습니까?

## Q3: 다중 YAML 파일 간 오버라이드 제약은 무엇입니까?

> 답은 §정답 절을 참조합니다.

### 심화

YAML 앵커(`&`, `*`)로 중복을 줄이는 것과 파일을 분할하는 것의 장단점은 무엇입니까?

## Q4: Reload API 방식 간 차이는 무엇입니까?

> 답은 §정답 절을 참조합니다.

### 심화

Token 기반 reload에서 토큰이 노출되었을 때 공격자가 할 수 있는 것은 무엇입니까? 어떻게 방어합니까?

## Q5: export → diff 드리프트 감지의 한계는 무엇입니까?

> 답은 §정답 절을 참조합니다.

### 심화

YAML 파서 기반 비교를 구현하려면 어떤 도구를 사용할 수 있습니까?

## Q6: Strict Secret Resolution은 언제 활성화해야 합니까?

> 답은 §정답 절을 참조합니다.

### 심화

strict 모드에서 새 시크릿을 추가할 때 무중단으로 적용하려면 어떤 순서로 진행해야 합니까?
