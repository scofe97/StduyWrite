...
> RBAC 권한 모델은 시크릿 격리(01-02)와 API 인증 스펙(04_api 03장)으로 직접 이어집니다.

- [01-02. 시크릿 관리와 최소 권한 원칙](01-02.시크릿%20관리와%20최소%20권한%20원칙.md) § "최소 권한 적용" — Role 정규식 패턴의 시크릿 적용
- [01-00. 점검 — 핵심 질문과 답 (인증·인가)](01-00.점검.핵심%20질문과%20답%20%28인증·인가%29.md) § "정답" — RBAC·Authorization Strategy 자가 점검
- [../04_api/03-01. 인증 API 스펙 (ID-Password + Crumb)](../04_api/03-01.인증%20API%20스펙%20%28ID-Password%20+%20Crumb%29.md) § "crumb·토큰" — API Token vs crumb(정답 3)의 스펙
- [../04_api/03-03. API 토큰 발급·회전·수명 점검](../04_api/03-03.API%20토큰%20발급·회전·수명%20점검.md) § "토큰 회전" — 관리자 토큰 위험(정답 4)의 회전 정책
