...
> 운영·GitOps는 도입 5스텝(02-01) 위에 서고, Reload 4채널(02-03)·K8s ConfigMap(05_operations)과 맞물립니다.

- [02-01. 설정을 코드로 — JCasC](02-01.설정을%20코드로%20%E2%80%94%20JCasC.md) § "도입 5스텝" — 운영의 전제가 되는 도입 절차
- [02-03. JCasC 시크릿과 실전 패턴](02-03.JCasC%20시크릿과%20실전%20패턴.md) § "Reload API 4채널" — plugins.txt 정합성(정답 3)·reload 심화
- [../05_operations/02-06. GCP K8s Jenkins 실전](../05_operations/02-06.GCP%20K8s%20Jenkins%20실전.md) § "ConfigMap" — Helm values vs ConfigMap(정답 2) 운영
- [../04_api/09-03. API 쿼리 최적화와 운영](../04_api/09-03.API%20쿼리%20최적화와%20운영.md) § "운영" — 재구축(정답 4)의 운영 관점 보조
