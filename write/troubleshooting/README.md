...
| 폴더 | 문자 | 문제가 사는 곳 | 문항 |
|------|------|--------------|------|
| [os/](./os/) | A | 리눅스 호스트 한 대 안 — 소켓·conntrack·MTU·라우팅·NIC | 3 |
| [kubernetes/](./kubernetes/) | B | 클러스터 안 — Pod 네트워크·Service·CoreDNS·CNI·NetworkPolicy·스케줄링 | 5 |
...
- [개념 노트](./_concepts/README.md) — 문항에서 갈라져 나온 이론 3편. 여러 문항에 걸리는 것만 여기 모읍니다
