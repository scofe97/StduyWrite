...
**출처** · 없음. 학습 노트와 [후보 풀](../_drill/candidates.md)에서 구성한 문항입니다 (외부 RCA 에서 뽑는 규약은 2026-09-08 부터)

![두 가지로 부르는 같은 대상 — 주소로 직접과 이름으로](../_assets/2026-09-07.service-topology.svg)
