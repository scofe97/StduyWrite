...
목록이 비어 있으면 selector와 라벨을 비교합니다.
...
근거는 [k8s-net 04-04 Service와 EndpointSlice](../../08_cloud/kubernetes/04_networking/)입니다. 이 사례는 [쿠버네티스 사례집 04-01 서비스 디스커버리](../../08_cloud/troubleshooting/) 사례 1에도 정리돼 있어, 그쪽을 먼저 읽고 여기로 왔습니다.
...
- [쿠버네티스 사례집 04-01](../../08_cloud/troubleshooting/) — 같은 주제의 원본 사례
