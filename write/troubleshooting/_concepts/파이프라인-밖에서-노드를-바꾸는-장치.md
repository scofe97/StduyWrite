...
`list-timers` 의 지난 발동 시각이 증상 시작과 맞물리면 그 타이머가 첫 용의자가 됩니다. 저널과 dpkg 기록에서 그 창에 어떤 패키지가 갈렸는지를 보면, 재시작한 데몬이 무엇이었는지까지 좁혀집니다. 이 사고에서는 그 패키지가 `systemd` 였고, 재시작한 데몬이 라우팅 테이블을 지웠습니다. 그 뒤의 이야기는 [한 노드의 라우팅 테이블을 둘이 만질 때](./%ED%95%9C-%EB%85%B8%EB%93%9C%EC%9D%98-%EB%9D%BC%EC%9A%B0%ED%8C%85-%ED%85%8C%EC%9D%B4%EB%B8%94%EC%9D%84-%EB%91%98%EC%9D%B4-%EB%A7%8C%EC%A7%88-%EB%95%8C.md) 에 있습니다.
...
- [한 노드의 라우팅 테이블을 둘이 만질 때](./%ED%95%9C-%EB%85%B8%EB%93%9C%EC%9D%98-%EB%9D%BC%EC%9A%B0%ED%8C%85-%ED%85%8C%EC%9D%B4%EB%B8%94%EC%9D%84-%EB%91%98%EC%9D%B4-%EB%A7%8C%EC%A7%88-%EB%95%8C.md) — 이 장치가 부른 재시작이 무엇을 지웠나
