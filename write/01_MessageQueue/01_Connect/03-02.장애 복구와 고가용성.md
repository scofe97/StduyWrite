...
- [02-redpanda-connect.md §3 — Output Wrapper](./02-redpanda-connect.md)
- [04-operations.md §3 — DLQ 개념과 rpk 재처리](./04-operations.md)
- [04-operations.md §4 — 모니터링과 트러블슈팅](./04-operations.md)
- [03-spring-boot-integration/06-idempotent-consumer.md](../03-spring-boot-integration/06-idempotent-consumer.md) — 업무 레벨 멱등성
