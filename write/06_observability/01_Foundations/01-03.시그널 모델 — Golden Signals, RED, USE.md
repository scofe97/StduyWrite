...
**Cardinality 폭발.** label에 user_id, request_id 같은 고-cardinality 값을 넣으면 Prometheus가 OOM된다. RED의 `status` label은 카테고리(2xx/4xx/5xx)로 묶어야 한다. 자세한 cardinality 관리는 [02-05.Grafana Mimir.md](02-05.Grafana%20Mimir.md)와 [04-01.관측 트러블슈팅.md](04-01.관측%20트러블슈팅.md)에 나뉘어 있다.
...
- [02-05.Grafana Mimir.md](02-05.Grafana%20Mimir.md) — 메트릭 cardinality 관리
- [03-07.실전 프로젝트 5(Outbox E2E 트레이스 연결).md](03-06.실전%20프로젝트%205(Outbox%20E2E%20트레이스%20연결).md) — 시그널이 가리키는 사건의 trace 추적
- [04-01.관측 트러블슈팅.md](04-01.관측%20트러블슈팅.md) — 시그널이 안 보이거나 잘못 보일 때 절차
