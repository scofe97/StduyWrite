...
![이름과 라벨과 값이 메트릭·시계열·샘플 세 층을 만드는 구조](_assets/05-01.metric-layers.svg)
...
![Graphite 의 한계가 Prometheus 를, Prometheus 의 한계가 Mimir 를 낳은 계보](_assets/05-01.storage-lineage.svg)
...
![집계된 메트릭에서 exemplar 를 거쳐 단일 요청 트레이스로 건너뛰는 경로](_assets/05-01.exemplar-hop.svg)
