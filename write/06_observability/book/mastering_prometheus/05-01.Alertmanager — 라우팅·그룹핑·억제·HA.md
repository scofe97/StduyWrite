...
flowchart LR
    ...
    style E fill:#0d0d0d,stroke:#5c544a,color:#e8e4df
    style F fill:#0d0d0d,stroke:#5c544a,color:#e8e4df
    style R fill:#d4a853,stroke:#d4a853,color:#000
    style G fill:#0d0d0d,stroke:#5c544a,color:#e8e4df
    style I fill:#0d0d0d,stroke:#5c544a,color:#e8e4df
    style N fill:#0d0d0d,stroke:#5c544a,color:#e8e4df
...
따라서 라벨이 없으면 빈 값으로 취급되어 `!=` 도 `!~` 도 만족합니다.
