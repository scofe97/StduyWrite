...
| 01-03 | [유비쿼터스 언어와 도메인 모델](01-03.유비쿼터스%20언어와%20도메인%20모델.md) | 도메인 언어는 코드에 어떻게 박히는가 |
...
| 02-04 | [DDD 전략적 설계와 전술적 패턴](02-04.DDD%20전략적%20설계와%20전술적%20패턴.md) | Bounded Context와 Aggregate 결정 기준 |
| 02-05 | [모듈러 모놀리스와 Spring Modulith](02-05.모듈러%20모놀리스와%20Spring%20Modulith.md) | 모놀리스 안에서 경계를 어떻게 강제할 것인가 |
| 02-06 | [헥사고날 변형 — TPS 결재 도메인 적용 사례](02-06.헥사고날%20변형%20—%20TPS%20결재%20도메인%20적용%20사례.md) | 실전 변형의 결정 근거 |
...
| 02-09 | [도메인 책임 분리와 세부 도메인 식별](02-09.도메인%20책임%20분리와%20세부%20도메인%20식별.md) | sub-domain과 bounded context를 어떻게 그릴 것인가 |
...
| 03-06 | [이벤트 기반 아키텍처](03-06.이벤트%20기반%20아키텍처.md) | 상태 변화를 사실의 흐름으로 다룰 때 얻는 것 |
| 03-07 | [CQRS](03-07.CQRS.md) | 쓰기·읽기 모델을 왜 갈라야 하는가 |
| 03-08 | [이벤트 소싱](03-08.이벤트%20소싱.md) | 현재 상태가 아닌 사건의 시퀀스를 저장한다는 결정 |
| 03-09 | [Saga, Outbox, Request-Response Bridge](03-09.Saga%2C%20Outbox%2C%20Request-Response%20Bridge.md) | 분산 트랜잭션의 실용적 대안 |
