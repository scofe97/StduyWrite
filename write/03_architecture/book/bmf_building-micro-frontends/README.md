...
learning:
  ...
  blocked_count:
  next_lesson: "03장 Discovering Micro-Frontend Architectures — 구현 방식을 분류·평가하는 장. 2장의 결정 프레임워크를 실제 기술 선택에 대는 자리입니다"
updated: 2026-08-31
---
...
| 항목 | 값 |
|------|-----|
| 난이도 레벨 | 기본 — 1·2장을 마쳐 결정 프레임워크와 경계 판단 어휘를 갖췄습니다 |
| 막힌 지점 | 없음 (1·2장은 개념·결정 장이라 코드가 거의 없습니다. 3장부터 구현이 들어옵니다) |
| 다음 레슨 후보 | 3장 Discovering Micro-Frontend Architectures — 2장이 세운 결정 프레임워크로 실제 구현 방식들을 분류·평가하는 장입니다 |
| 최근 검증 결과 | 1·2장 §1 센서 전부 통과. 원문 정오 3건 병기(실패 격리 문장 구조 · Table 2-1 예시 불일치 · 인증 이탈률 40%) |
| 복습 회차 | 0회차 (미실시) |
