...
learning:
  ...
  blocked_count:
  next_lesson: "05-01 서버 사이드 렌더링. 4장 Client-Side Rendering Micro-Frontends 를 4편으로 마쳤습니다"
updated: 2026-09-01
---
...
| 항목 | 값 |
|------|-----|
| 난이도 레벨 | 기본 — 1~4장을 마쳐 결정 프레임워크와 여섯 아키텍처의 점수 기준, 그리고 Module Federation 구현의 뼈대를 갖췄습니다 |
| 막힌 지점 | 없음 (4장은 코드가 들어오지만 실행 실습은 하지 않았습니다. 저자의 GitHub 예제를 돌려 보는 일이 남아 있습니다) |
| 다음 레슨 후보 | 5장 Server-Side Rendering Micro-Frontends. 4장은 39페이지를 4편으로 나눠 마쳤습니다 |
| 최근 검증 결과 | 1~4장 §1 센서 전부 통과. 원문 정오 4건 병기(실패 격리 문장 구조 · Table 2-1 예시 불일치 · 인증 이탈률 40% · 서버 사이드 단순성 항목의 자기모순) |
| 복습 회차 | 0회차 (미실시) |
