...
책은 크게 세 묶음으로 읽습니다. 도입부 3개 챕터(기초·추정·면접 방법론)를 한 묶음으로, CH4~15 는 개별 시스템 설계 사례로 봅니다. CH1~15 본편은 모두 작성을 마쳤고, CH16 은 실무 시스템 참고자료 링크 모음이라 별도 본편을 두지 않았습니다.
...
| CH14 | [`_assets/02-11.youtube.svg`](_assets/02-11.youtube.svg) — 업로드/스트리밍 흐름·트랜스코딩 DAG·비용 절감 |
| CH15 | [`_assets/02-12.google-drive.svg`](_assets/02-12.google-drive.svg) — 아키텍처·블록 서버 delta sync·동기화·저장 절약 |
