...
- [05-03.Outbox](../../04_messaging/05_ConsistencyPattern/02-01.Outbox.md) — 202 응답 이후 이벤트 발행 안정성을 보장하는 패턴
- [07-01.Kafka CQRS](../../04_messaging/07_CQRS_EventSourcing/01-01.Kafka%20CQRS.md) — Polling이 조회하는 Read Model을 이벤트로 구성하는 구조
- [05-05.Inbox](../../04_messaging/05_ConsistencyPattern/03-01.Inbox.md) — Status Consumer의 멱등 처리를 인프라 수준으로 강제하는 짝 패턴
