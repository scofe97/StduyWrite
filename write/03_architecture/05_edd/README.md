...
> 2026-05-23 재정의 — 옛 04_messaging/01_EDA/ (EDA 기초·요청응답·202 Polling)는 이 시리즈의 05_edd 05번대(아래 표)로 흡수됐다. "EDA 사고 모델 + Kafka 적용"이 이론 측 (01~04절) 옆에 같이 있는 게 학습 동선상 자연스럽다.
...
|----------------------|--------------------------|
| EDA 도입 동기, 사고 모델 (05번대) | (없음 — 05_edd 05번대로 이관됨) |
