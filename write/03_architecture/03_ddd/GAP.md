...
| 11_Dealing_with_Events_and_Their_Evolution | 04_edd/02-05 이벤트 진화 다루기 (위임) | draft (TBD, 04_edd 측) |
| 12_Orchestrating_Complexity | 04_edd/03-02 Choreography vs Orchestration (위임) | draft (TBD, 04_edd 측) |
...
5. 03-01 리팩토링 원칙
6. 04-02 이벤트와 CQRS 통합 (04_edd 의 02-01, 02-02 와 함께 작성 권장)
