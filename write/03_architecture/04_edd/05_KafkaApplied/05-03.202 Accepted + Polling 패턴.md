...
related:
  ...
  - 05-03.Outbox 패턴.md
  - ../../../04_messaging/06_CQRS_EventSourcing/06-01.Kafka CQRS.md
updated: 2026-05-16
---
...
- [05-03.Outbox](./../../../04_messaging/04_ConsistencyPattern/04-03.Outbox.md) — 202 응답 이후 이벤트 발행 안정성을 보장하는 패턴
- [07-01.Kafka CQRS](./../../../04_messaging/06_CQRS_EventSourcing/06-01.Kafka%20CQRS.md) — Polling이 조회하는 Read Model을 이벤트로 구성하는 구조
- [05-05.Inbox](./../../../04_messaging/04_ConsistencyPattern/04-05.Inbox.md) — Status Consumer의 멱등 처리를 인프라 수준으로 강제하는 짝 패턴
