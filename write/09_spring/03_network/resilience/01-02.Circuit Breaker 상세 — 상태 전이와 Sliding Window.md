...
- `../../../08_cloud/service-mesh/11-03.Istio 레질리언스.md` <!-- 링크 끊김(2026-08): ../../../08_cloud/service-mesh/11-03.Istio 레질리언스.md --> — Istio 의 *outlier detection* 이 *서비스 메시 레벨의 Circuit Breaker* 입니다. 같은 패턴이 *어플리케이션* (Resilience4j) 과 *인프라* (Istio) 양쪽에 있는 자리
