...
- [11_security 상위 MOC](../README.md) — 보안 카테고리 전체 진입
- [11_security/01_concepts](../01_concepts/README.md) — OAuth2·JWT·암호학 이론 (프레임워크 독립)
- [12_spring 통합 MOC](../../12_spring/README.md) — Spring 본질 이론 진입점
